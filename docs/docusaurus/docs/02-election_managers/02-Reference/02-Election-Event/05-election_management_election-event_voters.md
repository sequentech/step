...
You can add additional fields like the voter's birthday or sex. [Check out the tutorial for that](../../01-Tutorials/99-admin_portal_tutorials_add-user-attributes-to-keycloak).
