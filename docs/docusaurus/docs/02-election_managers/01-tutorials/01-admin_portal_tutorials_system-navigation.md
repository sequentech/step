...
- **System Logo and Version Number**: The logo of the system, along with the current version number, is displayed prominently for easy identification.
...
The side menu, located on the left of the screen, provides easy access to **Election Events**, **Settings**, **Users**, **Roles**, and **Communication Templates**. This omnipresent menu ensures seamless navigation across all screens, allowing you to quickly access system settings and manage Election Events.
...
The main content area, situated in the center of the screen, displays the currently selected section, whether it is an **Election Event**, **Settings**, or **Communication Templates**, among others.
