...
Edit your SimpleSAMLphp configuration (`config/config.php`)
...
3. **Mapper:**  
   ...
   * Create a mapper that maps a SAML attribute to a Keycloak user attribute. For the example we will create a mapper that maps the email.
     * Name: email-mapper
