...
**See also:** [X.509 Architecture](/docs/developers/Keycloak/x509_client_cert_architecture) — design, components, and multi-tenancy.
...
- [X.509 Architecture](/docs/developers/Keycloak/x509_client_cert_architecture) — end-to-end flow, infrastructure, multi-tenancy
