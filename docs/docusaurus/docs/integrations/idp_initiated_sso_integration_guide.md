...
### 2.4 Access the Reference Implementation

Once running, access:
- **Admin interface:** `http://localhost:8083/simplesaml/`
...
Use a SAML tracer (Firefox/Chrome extension) to inspect:
...
Replace staging URLs with production:
...
### 7.2 Exchange Production Certificates

- Provide Sequent with your **production IdP certificate**
- Update your IdP with Sequent's **production SP certificate**
