...
| config | 0.14 | MIT OR Apache-2.0 | Layered configuration system for Rust applications. |
...
| prost | 0.13.3 | Apache-2.0 | A Protocol Buffers implementation for the Rust Language. |
...
| toml | 0.8.19 | MIT OR Apache-2.0 | A native Rust encoder and decoder of TOML-formatted files and streams. Provides implementations of the standard Serialize/Deserialize traits for TOML data to facilitate deserializing and serializing Rust structures. |
...
| tracing-log | 0.2.0 | MIT | Provides compatibility between `tracing` and the `log` crate. |
| tracing-subscriber | 0.3.16 | MIT | Utilities for implementing and composing `tracing` subscribers. |
| tracing-tree | 0.4.0 | MIT OR Apache-2.0 | A Tracing Layer which prints a tree of spans and events. |
...
| config | 0.14.1 | MIT OR Apache-2.0 | Layered configuration system for Rust applications. |
| crepe | 0.1.5 | MIT OR Apache-2.0 | Datalog in Rust as a procedural macro |
| getrandom | =0.2.14 | MIT OR Apache-2.0 | A small cross-platform library for retrieving random data from system source |
| hex | 0.4.2 | MIT OR Apache-2.0 | Encoding and decoding data into/from hexadecimal representation. |
| log | 0.4.17 | MIT OR Apache-2.0 | A lightweight logging facade for Rust |
...
| serde | 1.0.152 | MIT OR Apache-2.0 | A generic serialization/deserialization framework |
| serde_json | 1.0.133 | MIT OR Apache-2.0 | A JSON serialization file format |
| strum | 0.26.3 | MIT | Helpful macros for working with enums and strings |
| thiserror | 2.0.3 | MIT OR Apache-2.0 | derive(Error) |
...
| wasm-bindgen | =0.2.101 | MIT OR Apache-2.0 | Easy support for interacting between JS and Rust. |
...
| serde_json | 1.0 | MIT OR Apache-2.0 | A JSON serialization file format |
| strum | 0.26 | MIT | Helpful macros for working with enums and strings |
| strum_macros | 0.26 | MIT | Helpful macros for working with enums and strings |
| tokio | 1.38.1 | MIT | An event-driven, non-blocking I/O platform for writing asynchronous I/O backed applications. |
| tonic | 0.12.3 | MIT | A gRPC over HTTP/2 implementation focused on high performance, interoperability, and flexibility. |
| tracing | 0.1 | MIT | Application-level tracing for Rust. |
| tracing-attributes | 0.1.23 | MIT | Procedural macro attributes for automatically instrumenting functions. |
...
| deadpool-postgres | 0.14.0 | MIT OR Apache-2.0 | Dead simple async pool for tokio-postgres |
...
| graphql_client | 0.14.0 | Apache-2.0 OR MIT | Typed GraphQL requests and responses |
...
| log | 0.4.17 | MIT OR Apache-2.0 | A lightweight logging facade for Rust |
| prost | 0.13.3 | Apache-2.0 | A Protocol Buffers implementation for the Rust Language. |
| prost-types | 0.13.3 | Apache-2.0 | Prost definitions of Protocol Buffers well known types. |
| serde | 1.0.152 | MIT OR Apache-2.0 | A generic serialization/deserialization framework |
| tonic | 0.12.3 | MIT | A gRPC over HTTP/2 implementation focused on high performance, interoperability, and flexibility. |
| tracing | 0.1 | MIT | Application-level tracing for Rust. |
| tracing-attributes | 0.1.23 | MIT | Procedural macro attributes for automatically instrumenting functions. |
...
| Dependency | Version | License | Description |
|------------|---------|---------|-------------|
| ammonia | 4.0.0 | MIT OR Apache-2.0 | HTML Sanitization |
| anyhow | 1.0.75 | MIT OR Apache-2.0 | Flexible concrete Error type built on std::error::Error |
...
| headless_chrome | 1.0.12 | MIT | Control Chrome programmatically |
...
| keycloak | 26.0.200 | Unlicense OR MIT | Keycloak Admin REST API. |
...
| openid | 0.18.3 | Unlicense OR MIT | OpenID Connect & Discovery client library using async / await. |
...
| reqwest-retry | 0.7.0 | MIT OR Apache-2.0 | Retry middleware for reqwest. |
| rocket | 0.5.0 | MIT OR Apache-2.0 | Web framework with a focus on usability, security, extensibility, and speed. |
| rusqlite | 0.32 | MIT | Ergonomic wrapper for SQLite |
...
| strum | 0.26 | MIT | Helpful macros for working with enums and strings |
| strum_macros | 0.26 | MIT | Helpful macros for working with enums and strings |
| tempfile | 3.8.0 | MIT OR Apache-2.0 | A library for managing temporary files and directories. |
...
| ed25519-dalek | =2.1.1 | BSD-3-Clause | Fast and efficient ed25519 EdDSA key generations, signing, and verification in pure Rust. |
| generic-array | 1.1.1 | MIT | Generic types implementing functionality of arrays |
| getrandom | =0.2.14 | MIT OR Apache-2.0 | A small cross-platform library for retrieving random data from system source |
| hex | 0.4.2 | MIT OR Apache-2.0 | Encoding and decoding data into/from hexadecimal representation. |
| malachite | 0.4.16 | LGPL-3.0-only | Arbitrary-precision arithmetic, with efficient algorithms partially derived from GMP, FLINT, and MPFR. |
| num-bigint | 0.4 | MIT/Apache-2.0 | Big integer implementation for Rust |
| num-integer | 0.1 | MIT OR Apache-2.0 | Integer traits and functions |
| num-modular | 0.6 | Apache-2.0 | Implementation of efficient integer division and modular arithmetic operations with generic number types. Supports various backends including num-bigint, etc.. |
| num-traits | 0.2 | MIT OR Apache-2.0 | Numeric traits for generic mathematics |
...
| rayon | 1.5 | MIT OR Apache-2.0 | Simple work-stealing parallelism for Rust |
| rcgen | 0.13.1 | MIT OR Apache-2.0 | Rust X.509 certificate generator |
...
| x509-parser | 0.16.0 | MIT OR Apache-2.0 | Parser for the X.509 v3 format (RFC 5280 certificates) |
...
| serde_json | 1.0.133 | MIT OR Apache-2.0 | A JSON serialization file format |
| strum | 0.26.3 | MIT | Helpful macros for working with enums and strings |
| strum_macros | 0.26.4 | MIT | Helpful macros for working with enums and strings |
| tempfile | 3.15.0 | MIT OR Apache-2.0 | A library for managing temporary files and directories. |
| tokio | 1.32.0 | MIT | An event-driven, non-blocking I/O platform for writing asynchronous I/O backed applications. |
| tracing | 0.1 | MIT | Application-level tracing for Rust. |
...
| csv | 1.3.0 | Unlicense/MIT | Fast CSV parsing with support for serde. |
| deadpool | 0.12.1 | MIT OR Apache-2.0 | Dead simple async pool |
| deadpool-postgres | 0.14.0 | MIT OR Apache-2.0 | Dead simple async pool for tokio-postgres |
| dotenv | 0.15.0 | MIT | A `dotenv` implementation for Rust |
...
| rocket | 0.5.0 | MIT OR Apache-2.0 | Web framework with a focus on usability, security, extensibility, and speed. |
| rusqlite | 0.32 | MIT | Ergonomic wrapper for SQLite |
| rust-s3 | 0.35.1 | MIT | Rust library for working with AWS S3 and compatible object storage APIs |
