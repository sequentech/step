...
Test file paths in this guide are relative to [`packages/step-cli/tests/`](https://github.com/sequentech/step/blob/feat/meta-13302-ui-essentials-coverage/release-10.0/packages/step-cli/tests). Commands state their working directory.
