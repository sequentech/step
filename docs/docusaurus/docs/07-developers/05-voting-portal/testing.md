...
Test file paths in this guide are relative to [`packages/voting-portal/tests/`](https://github.com/sequentech/step/blob/release/10.0/packages/voting-portal/tests). Commands state their working directory.
