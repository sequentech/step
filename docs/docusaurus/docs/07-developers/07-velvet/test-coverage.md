...
Test file paths in this guide are relative to [`packages/velvet/tests/`](https://github.com/sequentech/step/blob/main/packages/velvet/tests). Commands state their working directory.
...
[the browser setup action](https://github.com/sequentech/step/blob/main/.github/actions/setup-test-browser/action.yml).
