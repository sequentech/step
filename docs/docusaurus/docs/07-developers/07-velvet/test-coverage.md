...
Test file paths in this guide are relative to [`packages/velvet/tests/`](https://github.com/sequentech/step/blob/release/10.0/packages/velvet/tests). Commands state their working directory.
...
[the browser setup action](https://github.com/sequentech/step/blob/release/10.0/.github/actions/setup-test-browser/action.yml).
