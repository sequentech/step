...
Test file paths in this guide are relative to [`packages/windmill/tests/`](https://github.com/sequentech/step/blob/feat/meta-13302-ui-essentials-coverage/main/packages/windmill/tests). Commands state their working directory.
