...
Test file paths in this guide are relative to [`packages/electoral-log/tests/`](https://github.com/sequentech/step/blob/release/10.0/packages/electoral-log/tests). Commands state their working directory.
