...
Test file paths in this guide are relative to [`packages/sequent-core/tests/`](https://github.com/sequentech/step/blob/main/packages/sequent-core/tests). Commands state their working directory.
