...
Test file paths in this guide are relative to [`packages/harvest/tests/`](https://github.com/sequentech/step/blob/feat/meta-13302-ui-essentials-coverage/main/packages/harvest/tests). Commands state their working directory.
...
Keep [Meta #13302](https://github.com/sequentech/meta/issues/13302) open until the measured profile and its remaining gaps satisfy
