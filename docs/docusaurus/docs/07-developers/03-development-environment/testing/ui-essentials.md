...
Test file paths in this guide are relative to [`packages/ui-essentials/tests/`](https://github.com/sequentech/step/blob/release/10.0/packages/ui-essentials/tests). Commands state their working directory.
