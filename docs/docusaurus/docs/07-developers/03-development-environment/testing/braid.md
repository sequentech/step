...
not branches. The full protocol test runs two fixed trustee configurations: two
of three trustees, which leaves an unselected trustee and empty trustee set
