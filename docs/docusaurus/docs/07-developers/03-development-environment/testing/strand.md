...
Test file paths in this guide are relative to [`packages/strand/tests/`](https://github.com/sequentech/step/blob/main/packages/strand/tests). Commands state their working directory.
