...
Test file paths in this guide are relative to [`packages/ui-core/tests/`](https://github.com/sequentech/step/blob/main/packages/ui-core/tests). Commands state their working directory.
