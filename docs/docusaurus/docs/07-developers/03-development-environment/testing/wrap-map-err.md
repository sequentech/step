...
Test file paths in this guide are relative to [`packages/wrap-map-err/tests/`](https://github.com/sequentech/step/blob/release/10.0/packages/wrap-map-err/tests). Commands state their working directory.
