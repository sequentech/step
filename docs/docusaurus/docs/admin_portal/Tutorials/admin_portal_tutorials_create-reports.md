...
4. **Optional:** Choose a template. You must have created one earlier (see [more about creating templates](../Reference/User-Manual/Templates/admin_portal_reference_user-manual_templates.md)). If none is selected, the system's default will be used.
5. Click **Save**.
...
**Note:** To display male and female percentages, the sex attribute must have been added. Check out [how to add the sex attribute](admin_portal_tutorials_add-user-attributes-to-keycloak.md).
