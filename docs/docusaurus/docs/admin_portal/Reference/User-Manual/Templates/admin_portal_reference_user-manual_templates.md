...
You can also use this template when manually [creating reports](/docs/docusaurus/docs/admin_portal/Tutorials/admin_portal_tutorials_create-reports) in the Reports tab.
