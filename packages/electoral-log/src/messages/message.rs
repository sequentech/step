...
impl Message {
    ...
    pub fn cast_vote_error_message(
        ...
        Self::from_body(
            event, body, sd, voter_id, None, /* username */
            None, None,
        ) //TODO: yuval change this
    }
    ...
    pub fn election_published_message(
        ...
        Self::from_body(event, body, sd, user_id, username, None, None) //TODO: yuval change this
    }
