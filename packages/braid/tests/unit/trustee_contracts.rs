...
use crate::{protocol::trustee2::Trustee, util::ProtocolError};
use b3::messages::{artifact::Configuration, message::Message, protocol_manager::ProtocolManager};
...
fn fixture() -> (Trustee<RistrettoCtx>, Message, Message) {
...
fn bootstrap_count_includes_configuration_and_following_acknowledgement() {
    ...
    assert_eq!(trustee.update_local_board(vec![]).unwrap().0, 0);
}
