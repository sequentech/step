...
const frenchTranslation: TranslationType = {
    translations: {
        ...
        ballotLocator: {
            ...
            found: "Votre numéro d'identification de bulletin {{ballotId}} a été localisé",
            notFound: "Votre numéro d'identification de bulletin {{ballotId}} n'a pas été localisé",
