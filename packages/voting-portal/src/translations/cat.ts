...
const catalanTranslation: TranslationType = {
    translations: {
        ...
        electionSelectionScreen: {
            ...
            alerts: {
                noElections:
                    "No hi ha eleccions en les quals pugueu votar. Això podria ser perquè l'àrea no té cap contesa associada. Si us plau, torneu-ho a intentar més tard o contacteu amb suport per obtenir ajuda.",
