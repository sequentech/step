	...
	translations: {
		...
		reviewScreen: {
			...
			error: {
				...
				LOAD_ELECTION_EVENT: "Non se pode cargar o evento de eleccións. Inténtao de novo máis tarde.",
				CAST_VOTE:
		...
		confirmationScreen: {
			...
			errorDialogPrintVoteReceipt: {
				title: "Erro",
				content: "Produciuse un erro, intenta de novo",
				ok: "Aceptar"
			},
		...
		electionSelectionScreen: {
			...
			description: "Selecciona a papeleta na que desexas votar",
			chooserHelpDialog: {
				title: "Información: Lista de papeletas",
				content:
					"Benvido á cabina de votación, esta pantalla mostra a lista de papeletas nas que podes votar. As papeletas que se amosan nesta lista poden estar abertas á votación, programadas ou pechadas. Só poderás acceder á papeleta se o período de votación está aberto.",
				ok: "Aceptar"
			},
			noResults: "Non hai papeletas dispoñibles por agora.",
			demoDialog: {
				title: "Cabina de votación en modo de demostración",
				content:
					"Estás a entrar nunha cabina de votación en modo de demostración. <strong>O teu voto NON será emitido.</strong> Esta cabina de votación é só para fins de demostración.",
				ok: "Acepto que o meu voto non será emitido"
			},
			errors: {
				noVotingArea:
					"A área de votación non está asignada ao votante. Inténtao de novo máis tarde ou contacta co soporte para obter axuda.",
				networkError:
					"Houbo un problema de rede. Inténtao de novo máis tarde ou contacta co soporte para obter axuda.",
				unableToFetchData:
					"Houbo un problema ao obter os datos. Inténtao de novo máis tarde ou contacta co soporte para obter axuda.",
				noElectionEvent:
					"O evento de eleccións non existe. Inténtao de novo máis tarde ou contacta co soporte para obter axuda.",
				ballotStylesEmlError:
					"Houbo un erro co estilo de papeleta publicado. Inténtao de novo máis tarde ou contacta co soporte para obter axuda.",
				obtainingElectionFromID:
					"Houbo un erro ao obter eleccións asociadas cos seguintes IDs de eleccións: {{electionIds}}. Inténtao de novo máis tarde ou contacta co soporte para obter axuda."
			},
	},
		alerts: {
			noElections:
				"Non hai eleccións nas que poidas votar. Isto pode deberse a que a área non ten ningún concurso asociado. Inténtao de novo máis tarde ou contacta co soporte para obter axuda.",
			electionEventNotPublished:
				"O evento de eleccións aínda non foi publicado. Inténtao de novo máis tarde ou contacta co soporte para obter axuda."
		},
	errors: {
		encoding: {
		...
		explicit: {
			notAllowed: "A papeleta está marcada como explícitamente inválida, pero a pregunta non o permite",
