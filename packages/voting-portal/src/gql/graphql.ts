...
export type GetSignedUrlsMutationVariables = Exact<{
  eventId: Scalars['uuid']['input'];
}>;


export type GetSignedUrlsMutation = { __typename?: 'mutation_root', get_signed_urls?: { __typename?: 'getSignedUrlsOutput', urls?: Array<string | null> | null } | null };
...
export const GetSignedUrlsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"GetSignedUrls"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"eventId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"uuid"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"get_signed_urls"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"election_event_id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"eventId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"urls"}}]}}]}}]} as unknown as DocumentNode<GetSignedUrlsMutation, GetSignedUrlsMutationVariables>;
