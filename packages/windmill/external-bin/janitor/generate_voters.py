...
# Adjust if needed
json_file_path = './export_election_event-0b1e17c4-2c0f-457d-b645-9df449310b6e.json'
...
excluded_columns = ['password_salt', 'hashed_password']
...
for i in range(num_users):
    ...
    if sequence_email_number == True:
        ...
        email = f"{email_prefix}+{i + 20000 +sequence_start_number}@{domain}"
    else:
