...
/// Updates election status to allow tally and stops the triggering scheduled event.
#[instrument(err)]
...
mod manage_election_allow_tally_task {
    #![allow(missing_docs)]
    ...
    pub async fn manage_election_allow_tally(
        tenant_id: String,
        election_event_id: String,
        scheduled_event_id: String,
        election_id: String,
        ...
        let res = provide_hasura_transaction(|hasura_transaction| {
            ...
            Box::pin(async move {
                manage_election_allow_tally_wrapped(
                    hasura_transaction,
                    tenant_id,
                    election_event_id,
                    scheduled_event_id,
...
pub use manage_election_allow_tally_task::manage_election_allow_tally;
