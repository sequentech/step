...
//! Infrastructure adapters for the board repository ports.
//!
//! These adapters bridge the board contracts with existing protocol-manager
//! and board-interactions helpers. They are intentionally thin and rely on
//! caller-owned transactions supplied at construction time.

use super::{BallotBoardRepository, InsertBallotsBoardContext, PrepareBoardContextRequest};
...
/// Protocol-manager-backed implementation of `BallotBoardRepository`.
///
...
#[async_trait]
impl BallotBoardRepository for ProtocolManagerBoardPort<'_> {
