...
//! Initialization report template renderer.
//!
//! This report integrates with the shared template-rendering pipeline and
//! provides system-side variables (such as the QR-code JS library location)
//! required by the PDF rendering backend.
...
/// System-side variables used by the initialization report system template.
...
#[derive(Debug)]
/// Renderer for the initialization report templates.
