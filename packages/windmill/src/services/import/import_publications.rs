...
pub async fn process_record(
    ...
    // old election ids for publication of election event
    let old_election_ids = record
        .get(10)
    ...
    let election_id = if old_election_ids.is_some() {
        Some(
            replacement_map
                .get(&old_election_ids.unwrap().to_string())
    ...
    // old election ids for publication of single election
    ...
    let ballot_publication = BallotPublication {
        ...
        annotations,
        deleted_at: None,
        created_by_user_id: todo!(), //TODO: understand how to map it
        is_generated: todo!(),
        election_ids: todo!(),
        published_at: todo!(),
        election_id,
    ...
    // insert_new_scheduled_event(hasura_transaction, ballot_publication.clone())
    //     .await
