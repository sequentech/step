...
pub async fn verify_application(
    ...
    let (mut permission_label, area_id) =
        get_permission_label_and_area_from_applicant_data(
            hasura_transaction,
            applicant_data,
            tenant_id,
            election_event_id,
...
async fn get_permission_label_and_area_from_applicant_data(
    ...
    return get_permission_label_from_post(hasura_transaction, &post_name, &post_description, tenant_id, election_event_id).await;
}
