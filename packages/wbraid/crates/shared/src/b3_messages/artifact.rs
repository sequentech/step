...
use crate::b3_messages::newtypes::PROTOCOL_MANAGER_INDEX;
use crate::b3_messages::newtypes::{BatchNumber, MixNumber};
...
impl<C: Ctx> Configuration<C> {
    ...
    pub fn is_valid(&self) -> bool {
        ...
        (unique.len() == self.trustees.len())
            && (self.trustees.len() > 1
                && self.trustees.len() <= crate::b3_messages::newtypes::MAX_TRUSTEES)
