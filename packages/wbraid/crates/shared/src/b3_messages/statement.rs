...
use crate::b3_messages::newtypes::*;
...
impl Statement {
    ...
    pub(crate) fn ballots_stmt(
        ...
        pk_h: PublicKeyHash,
        batch: BatchNumber,
        trustees: [usize; crate::b3_messages::newtypes::MAX_TRUSTEES],
    ) -> Statement {
        Statement::Ballots(
            Self::timestamp(),
            cfg_hash,
...
impl BorshDeserialize for ChannelsHashes {
    fn deserialize_reader<R: std::io::Read>(reader: &mut R) -> Result<Self, std::io::Error> {
        ...
        let mut ret = [[0u8; 64]; crate::b3_messages::newtypes::MAX_TRUSTEES];
...
pub(crate) mod tests {
    ...
    fn test_serialize_channelshashes() {
        let hashes = [[0u8; 64]; crate::b3_messages::newtypes::MAX_TRUSTEES];
