...
wasm-bindgen ../../target/wasm32-unknown-unknown/release/braid_b5.wasm --out-dir pkg --target web
...
Write-Host "Build complete! WASM bundle ready in crates/braid_b5/pkg/" -ForegroundColor Green
