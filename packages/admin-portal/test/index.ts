...
export const testUrl = process.env.TEST_URL || "http://127.0.0.1:3002"
export const admin_portal_username = process.env.ADMING_PORTAL_TEST_USERNAME || "admin"
export const admin_portal_password = process.env.ADMING_PORTAL_TEST_USERNAME || "admin"
