...
export const testUrl = process.env.TEST_URL || "https://admin-portal-dev.sequent.vote"
export const admin_portal_username = process.env.ADMIN_PORTAL_TEST_USERNAME || "admin"
export const admin_portal_password = process.env.ADMIN_PORTAL_TEST_USERNAME || "admin"
