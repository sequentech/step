...
const MonitoringDashboardElectionEvent: React.FC<MonitoringDashboardElectionEventProps> = (
    ...
    const stats: ElectionEventStatsProps = useMemo(() => {
        return {
            ...
            electionsWithKioskCount: data?.total_elections_with_kiosk ?? "-",
            ...
            kioskClosedVotesCount: data?.total_kiosk_closed_votes ?? "-",
            kioskNotClosedVotesCount: data?.total_kiosk_not_closed_votes ?? "-",
