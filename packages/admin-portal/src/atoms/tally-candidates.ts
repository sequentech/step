import {GetTallyDataQuery, Sequent_Backend_Area, Sequent_Backend_Area_Contest, Sequent_Backend_Results_Area_Contest, Sequent_Backend_Results_Contest} from "@/gql/graphql"
