...
import { ElectionEventStatus, PublishStatus } from "../Publish/EPublishStatus"
import { PublishActions } from "../Publish/PublishActions"
import { EPublishActionsType } from "../Publish/EPublishType"
...
export const PublishList: React.FC<TMonitorhList> = ({
    status,
    electionStatus,
    electionId,
    electionEventId,
