...
// ---------------------------------------------------------------------
const DashboardElectionEvent = lazy(() =>
...
const ElectoralLog = lazy(() =>
  import("./ElectoralLog").then(m => ({default: m.ElectoralLog}))
)
...
export const ElectionEventTabs: React.FC = () => {
  ...
  const showPublish =
    !isElectionEventLocked &&
    authContext.isAuthorized(true, authContext.tenantId, IPermissions.ELECTION_EVENT_PUBLISH_TAB)
