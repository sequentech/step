...
export function useUsersPermissions() {
    ...
    const canEditVotersWhoVoted = authContext.isAuthorized(true, tenantId, IPermissions.VOTER_VOTED_EDIT)
    const canEditVotersEmailTlf = authContext.isAuthorized(true, tenantId, IPermissions.VOTER_EMAIL_TLF_EDIT)
