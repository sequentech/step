    ...
    translations: {
        ...
        electionTypeScreen: {
            ...
            tabs: {
                ...
                trustees: "AUTORITATS",
                BackupRestore: "CÒPIA DE SEGURETAT / RESTAURACIÓ",
            },
        },
        ...
        electionEventScreen: {
            common: {
                ...
                allowPublishAfterLockdown: "Només permet la publicació de l'esdeveniment electoral després del confinament",
            ...
            edit: {
                ...
                realm_attributes_load_error: "S'ha produït un error en carregar els atributs del realm de Keycloak",
                realm_attributes_update_error: "S'ha produït un error en actualitzar els atributs del realm de Keycloak",
                realm_attributes_not_loaded:
                    "No s'han carregat els atributs del realm de Keycloak, els canvis no s'han desat",
                password_policy: "Política de contrasenyes",
                password_policy_load_error: "S'ha produït un error en carregar la política de contrasenyes de Keycloak",
                password_policy_update_error: "S'ha produït un error en actualitzar la política de contrasenyes de Keycloak",
                password_policy_not_loaded:
                    "No s'ha carregat la política de contrasenyes de Keycloak, els canvis no s'han desat",
            },
            customUrls: {
        ...
        usersAndRolesScreen: {
            ...
            users: {
                ...
                delete: {
                    ...
                    bulkBodySelected: "Esborra els {{count}} usuaris seleccionats? Aquesta acció no es pot desfer.",
                    bulkBodyChoose:
                        "S'han seleccionat {{count}} usuaris. En lloc d'això, pots esborrar tots els usuaris que coincideixin amb els filtres actuals, que poden ser més. Aquesta acció no es pot desfer.",
                    okSelected: "Esborra els {{count}} seleccionats",
                    okAllMatching: "Esborra tots els coincidents",
                },
                notifications: {
            ...
            voters: {
                ...
                delete: {
                    ...
                    bulkBodySelected:
                        "Esborra els {{count}} votants seleccionats? Aquesta acció no es pot desfer.",
                    bulkBodyChoose:
                        "S'han seleccionat {{count}} votants. En lloc d'això, pots esborrar tots els votants que coincideixin amb els filtres actuals, que poden ser més. Aquesta acció no es pot desfer.",
                    okSelected: "Esborra els {{count}} seleccionats",
                    okAllMatching: "Esborra tots els coincidents",
                },
                notifications: {
        ...
        eventsScreen: {
            ...
            eventType: {
                label: "Tipus",
                ALLOW_INIT_REPORT: "Permet l'Informe d'Inicialització",
                START_VOTING_PERIOD: "Inici del Període de Votació",
                END_VOTING_PERIOD: "Final del Període de Votació",
                ALLOW_VOTING_PERIOD_END: "Permet el Final del Període de Votació",
        ...
        importResource: {
            ...
            ImportHashMismatch: "Els hashes no coincideixen. Error en la comprovació d'integritat.",
        },
        sideMenu: {
        ...
        tally: {
            ...
            resultsPublication: {
                sectionTitle: "Publica al lloc web de resultats",
                ...
                areaBased: "Basat en àrees",
                publishStarted: "S'ha iniciat la publicació de resultats",
                publishError: "No s'ha pogut iniciar la publicació de resultats",
                revoked: "S'ha revocat la publicació de resultats",
                revokeError: "No s'ha pogut revocar la publicació de resultats",
                waitingForTally: "Els resultats es podran publicar quan aquest recompte s'hagi completat.",
                writePermissionRequired:
                    "Necessites el permís publish-results-write per publicar o revocar resultats.",
                readPermissionRequired:
                    "Necessites el permís publish-results-read per veure l'historial de publicacions.",
                disabledPolicy:
                    "La publicació al lloc web de resultats està desactivada per a aquest esdeveniment electoral. Activa-la a les dades de l'esdeveniment electoral abans de publicar resultats.",
                loadingElectionContext: "La publicació de resultats està carregant el context de l'elecció.",
                route: "Ruta",
                ...
                fullPublishedScope: "Abast complet publicat",
                personalVisibility: "Visibilitat personal",
                contests: "Concursos",
                noTalliedContests: "No hi ha concursos escrutats disponibles.",
                publishSelectedContests: "Publica els concursos seleccionats",
                selectedContestCount: "{{count}} concurs seleccionat",
                selectedContestCount_plural: "{{count}} concursos seleccionats",
                ...
                confirmTitle: "Vols iniciar la publicació al lloc web de resultats?",
                confirmDescription:
                    "Això crearà una nova publicació a partir de l'execució actual del recompte. Els resultats visibles per als votants es mantenen actius fins que aquesta tasca de publicació es completi correctament.",
                close: "Tancar",
            },
            transmissionPackage: {
