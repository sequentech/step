    ...
    "translations": {
        ...
        "votingScreen": {
            ...
            "ballotHelpDialog": {
                ...
                "content": "Aquesta pantalla mostra la votació en la qual vostè és elegible per votar. Pot seleccionar la seva secció activant la casella de la dreta Candidat/Resposta. Per restablir les seves seleccions, faci clic al botó «<b>Esborrar selecció</b>», per passar al següent pas, faci clic al botó «<b>Siguiente</b>».",
                "ok": "D'acord"
            }
        },
        "startScreen": {
            ...
            "step1Description": "Seleccioneu les seves opcions de vot que es presenten una a una. Configurarà així les preferències de la seva papereta.",
            "step2Title": "2. Reviseu la vostra papereta",
            "step2Description": "Una vegada ha triat les seves preferències, procedirem a xifrar-les i obtindrà un localitzador. Li mostrarem el contingut de la seva papereta perquè pugui revisar-la.",
            "step3Title": "3. Envieu el vostre vot",
            "step3Description": "Pot enviar el seu vot a l'urna electrònica perquè sigui degudament registrat."
        },
        "reviewScreen": {
            "title": "Revisi la seva papereta",
            "description": "Per fer canvis en les seves seleccions, faci clic al botó «<b>Canviar selecció</b>», per confirmar les seves seleccions, faci clic al botó «<b>Enviar Papereta</b>» a continuació, i per auditar la seva papereta faci clic al botó «<b>Auditar la Papereta</b>» a continuació. Tingui en compte que una vegada enviada la seva papereta, ha votat i no se li emetrà una altra papereta per aquesta elecció.",
        ...
        "confirmationScreen": {
            ...
            "description": "El codi de confirmació que apareix a continuació verifica que <b>el seu vot s'ha emès correctament</b>. Pot utilitzar aquest codi per verificar que el seu vot ha estat comptabilitzat.",
            "ballotId": "Localitzador del Vot",
            "printButton": "Imprimir",
            "finishButton": "Finalitzar",
            "verifyCastTitle": "Comproveu que el seu vot ha estat emès",
            "verifyCastDescription": "Pot comprovar en tot moment que la seva papereta s'ha emès correctament utilitzant el següent codi QR:",
            "confirmationHelpDialog": {
                "title": "Informació: Pantalla de confirmació",
                "content": "Aquesta pantalla mostra que el seu vot s'ha emès correctament. La informació proporcionada en aquesta pàgina li permet verificar que la papereta ha estat emmagatzemada a l'urna, aquest procés pot ser executat en qualsevol moment durant el període de votació i després que l'elecció hagi estat tancada.",
                "ok": "D'acord"
            },
            "ballotIdHelpDialog": {
                "title": "Informació: Localitzador del Vot",
                "content": "El Localitzador del Vot de papereta és un codi que li permet trobar la seva papereta a l'urna, aquest Localitzador és únic i no conté informació sobre les seves seleccions.",
                "ok": "D'acord"
            }
        },
        "auditScreen": {
            ...
            "step1Description": "El seu <b>Localitzador del Vot</b> que apareix a la part superior de la pantalla i la seva papereta encriptada a continuació:",
            "step1HelpDialog": {
                "title": "Copiar el Vot Encriptat",
                "content": "Pot descarregar o copiar el seu Vot Encriptat per auditar-lo i verificar que el contingut encriptat conté les seves seleccions.",
                "ok": "D'acord"
            },
            "downloadButton": "Descarregar",
            "step2Title": "2. Seguiu els passos d'aquest tutorial",
            "step2Description": "(<a href=\"https://github.com/sequentech/new-ballot-verifier/blob/main/README.md\">faci clic aquí</a>, s'obrirà una nova pestanya al seu navegador)",
            "step2HelpDialog": {
                "title": "Tutorial sobre l'Auditoria del Vot",
                "content": "Per auditar el seu vot haurà de seguir els passos indicats en el tutorial, que inclouen la descàrrega d'una aplicació d'escriptori utilitzada per verificar el vot encriptat independentment del lloc web.",
                "ok": "D'acord"
            },
            "bottomWarning": "Per motius de seguretat, quan auditi la seva papereta, haurà d'invalidar-la. Per continuar amb el procés de votació, faci clic a ‘<b>Iniciar votació</b>’."
        },
        ...
        "scheduleScreen": {
            ...
            "create": {
                "title": "Crear data",
                "selectSchedule": "Seleccioneu un horari de la llista predefinida o escriviu-ne un de personalitzat"
            },
            "edit": {
                "title": "Editar data"
            },
            "eventTypes": {
                "SYSTEM_LOCKDOWN_FOR_INTERNET_VOTING_SETTINGS": "Bloqueig del sistema per a la finalització de la configuració de votació per Internet",
        ...
        "electionEventScreen": {
            ...
            "keys": {
                ...
                "notify": {
                    "participateNow": "Ha estat convidat a participar a una Cerimònia de Claus. Si us plau <1>feu clic a continuació en l'acció de clau de la cerimònia</1> per participar."
                }
            },
            "tabs": {
            ...
            "tally": {
                ...
                "notify": {
                    "participateNow": "Ha estat convidat a participar a una Cerimònia de Recompte. Si us plau <1>feu clic a continuació en l'acció de recompte de la cerimònia</1> per participar."
                }
            },
            "import": {
                ...
                "voters": "Votants",
                "votersParagraph": "Importa votants utilitzant una fulla de càlcul en format Tab Separated Values (TSV). Descarregueu un exemple de fitxer d'importació TSV aquí.",
                "electionEventParagraph": "Importa Esdeveniments Electorals utilitzant un fitxer JSON.",
                "elections": "Eleccions",
                "areas": "Àrees",
                ...
                "shaDialog": {
                    ...
                    "description": "No va introduir el camp Verificació d'integritat (SHA-256). Confirmeu que està importanr el fitxer correcte i que desitja importar-lo."
                }
            }
        },
        "electionScreen": {
        ...
        "usersAndRolesScreen": {
            ...
            "users": {
                ...
                "fields": {
                    ...
                    "passwordUppercaseValidate": "La contrasenya ha de contenir almenys una lletra majúscula",
                    "passwordLowercaseValidate": "La contrasenya ha de contenir almenys una lletra minúscula",
                    "passwordDigitValidate": "La contrasenya ha de contenir almenys un dígit",
                    "passwordSpecialCharValidate": "La contrasenya ha de contenir almenys un caràcter especial"
                },
                "delete": {
            ...
            "voters": {
                ...
                "notifications": {
                    ...
                    "manualVerificationSuccess": "Verificat amb èxit manualment al votant, descarregar PDF.."
                }
            },
            "roles": {
                "title": "Rols",
        ...
        "keysGeneration": {
            "configureStep": {
                ...
                "subtitle": "En aquesta cerimònia cada autoritat generarà i descarregarà la seva part de les claus privades per a l'Esdeveniment Electoral. Per continuar, trieu les autoritats que participaran en la cerimònia i el llindar, que és el nombre mínim d'autoritats necessaris per comptar.",
                "trusteeList": "Autoritats",
                "threshold": "Llindar",
                "errorMinTrustees_one": "Has seleccionat només {{selected}} autoritat, però has de seleccionar almenys {{threshold}}.",
                "errorMinTrustees_other": "Has seleccionat només {{selected}} autoritats, però has de seleccionar almenys {{threshold}}.",
                "errorThreshold": "Has seleccionat un llindar de {{selected}} però ha d'estar entre {{min}} i {{max}}.",
                ...
                "confirmdDialog": {
                    ...
                    "description": "Estàs a punt de Crear una Cerimònia de Claus. Aquesta acció notificarà a les Autoritats per participar en la creació i distribució de les Claus de l'Esdeveniment Electoral."
                }
            },
            "ceremonyStep": {
                "cancel": "Cancel·lar Cerimònia de Claus",
                "progressHeader": "Progrés de Cerimònia de Claus",
                "description": "Aquesta pantalla mostra el progrés i els registres de la Cerimònia de Claus de l'Esdeveniment Electoral. En la Cerimònia de Claus, cada autoritat generarà i descarregarà el seu fragment de la clau privada per a l'Esdeveniment Electoral.",
                ...
                "confirmdDialog": {
                    ...
                    "description": "Estàs a punt de Cancel·lar la Cerimònia de Claus. Després de realitzar aquesta acció, per tenir una Cerimònia de Claus exitosa hauràs de Crear una nova."
                },
                "header": {
            ...
            "startStep": {
                ...
                "subtitle": "Estàs a punt de participar en la Cerimònia de Claus com l'Autoritat (<strong>{{name}}</strong>). Això implica els següents passos:",
            ...
            "downloadStep": {
                ...
                "subtitle": "Per continuar, si us plau descarrega i guarda la teva Clau Privada Encriptada en almenys dos dispositius diferents:",
                ...
                "confirmdDialog": {
                    ...
                    "description": "Si us plau, realitza una còpia de seguretat de la teva Clau Privada Encriptada en almenys dues ubicacions segures diferents i després confirma-ho a continuació:",
            ...
            "checkStep": {
                ...
                "subtitle": "Puja la Còpia de Seguretat de la teva Clau Privada Encriptada per verificar que sigui correcta. Pots intentar-ho tantes vegades com sigui necessari, des de les teves diferents còpies de seguretat:",
                "errorUploading": "Còpia de Seguretat de la Clau Encriptada Privada invàlida, si us plau intenta-ho de nou",
        ...
        "tally": {
            ...
            "common": {
                ...
                "dialog": {
                    ...
                    "message": "Estàs a punt d'iniciar una cerimònia de recompte. Aquesta acció notificarà als trustees per importar els seus fragments de clau.",
                    "cancelMessage": "Estàs a punt de cancel·lar la cerimònia de recompte. Aquesta acció no es pot desfer.",
                    "ceremony": "Tots els trustees requerits han verificat els seus fragments de clau. Tot està a punt per començar a rebre resultats. Voleu iniciar el Recompte?"
                }
            },
            "table": {
                "elections": "Eleccions",
