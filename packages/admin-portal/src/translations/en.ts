    ...
    translations: {
        ...
        tally: {
            ...
            transmissionPackageServersDescription:
                "Export transmission package to miru or download them",
            sendToTransmissionPackageServers: "Send Transmission Package for area '{{name}}'",
            transmissionPackageSignatures: "Signatures",
            uploadTransmissionPackage: "Sign Package",
            uploadTransmissionPackageDesc:
                "Upload your signature to sign the Electoral Results package. This is an optional operation.",
