    ...
    translations: {
        ...
        electionEventScreen: {
            common: {
                ...
                allowPublishAfterLockdown: "Payagan lamang ang paglalathala ng kaganapan sa halalan pagkatapos ng lockdown",
            ...
            edit: {
                ...
                realm_attributes: "Mga attribute ng Keycloak realm",
                realm_attributes_load_error: "Error sa pag-load ng mga attribute ng Keycloak realm",
                realm_attributes_update_error: "Error sa pag-update ng mga attribute ng Keycloak realm",
                realm_attributes_not_loaded:
                    "Hindi na-load ang mga attribute ng Keycloak realm, hindi na-save ang mga pagbabago",
                password_policy: "Patakaran sa Password",
                password_policy_load_error: "Error sa pag-load ng patakaran sa password ng Keycloak",
                password_policy_update_error: "Error sa pag-update ng patakaran sa password ng Keycloak",
            ...
            field: {
                ...
                redirectFinishUrl: "URL ng Pag-redirect sa Pagtatapos",
                css: "Custom CSS",
        ...
        usersAndRolesScreen: {
            ...
            users: {
                ...
                delete: {
                    ...
                    bulkBodySelected: "Tanggalin ang {{count}} napiling tagagamit? Hindi na ito maaaring bawiin.",
                    bulkBodyChoose:
                        "{{count}} tagagamit ang napili. Sa halip, maaari mong tanggalin ang lahat ng tagagamit na tumutugma sa kasalukuyang mga filter, na maaaring mas marami. Hindi na ito maaaring bawiin.",
                    okSelected: "Tanggalin ang {{count}} napili",
                    okAllMatching: "Tanggalin lahat ng tumutugma",
                },
                notifications: {
            ...
            voters: {
                ...
                delete: {
                    ...
                    bulkBodyChoose:
                        "{{count}} botante ang napili. Sa halip, maaari mong tanggalin ang lahat ng botante na tumutugma sa kasalukuyang mga filter, na maaaring mas marami. Hindi na ito maaaring bawiin.",
                    okSelected: "Tanggalin ang {{count}} napili",
                    okAllMatching: "Tanggalin lahat ng tumutugma",
                },
                notifications: {
        ...
        reportsScreen: {
            ...
            messages: {
                ...
                decryptFileTitle: "Paano i-decrypt ang file",
                decryptInstructions:
        ...
        importResource: {
            ...
            ImportHashMismatch: "Hindi tumutugma ang mga hash. Nabigo ang pagsusuri ng integridad.",
        },
        sideMenu: {
        ...
        contestScreen: {
            ...
            underVotePolicy: {
                ...
                "allowed": "Tinogotan",
                "warn-only-in-review": "Magbabala Lamang sa Pagsusuri",
                "warn": "Patanid",
        ...
        tally: {
            ...
            resultsPublication: {
                ...
                policyAccess: "Access sa Website ng mga Resulta",
                policyVisibility: "Visibility ng Website ng mga Resulta",
                enabled: "Naka-enable",
                disabled: "Naka-disable",
                fullEvent: "Buong kaganapan",
                areaBased: "Batay sa lugar",
                publishStarted: "Nagsimula na ang paglalathala ng mga resulta",
                publishError: "Hindi masimulan ang paglalathala ng mga resulta",
                revoked: "Binawi ang paglalathala ng mga resulta",
                revokeError: "Hindi mabawi ang paglalathala ng mga resulta",
                waitingForTally: "Maaaring ilathala ang mga resulta kapag natapos na ang tally na ito.",
                writePermissionRequired:
                    "Kailangan mo ng permiso na publish-results-write upang mailathala o mabawi ang mga resulta.",
                readPermissionRequired:
                    "Kailangan mo ng permiso na publish-results-read upang makita ang kasaysayan ng paglalathala.",
                disabledPolicy:
                    "Naka-disable ang paglalathala sa website ng mga resulta para sa kaganapang panghalalan na ito. I-enable ito sa datos ng kaganapang panghalalan bago maglathala ng mga resulta.",
                loadingElectionContext: "Nilo-load ng paglalathala ng mga resulta ang konteksto ng halalan.",
                route: "Ruta",
                ...
                authenticatedAccess: "Naka-authenticate na access",
                visibility: "Visibility",
                fullPublishedScope: "Buong nailathalang saklaw",
                personalVisibility: "Personal na visibility",
                contests: "Mga Paligsahan",
                noTalliedContests: "Walang available na na-tally na paligsahan.",
                publishSelectedContests: "Ilathala ang mga napiling paligsahan",
                selectedContestCount: "{{count}} paligsahan ang napili",
                selectedContestCount_plural: "{{count}} na paligsahan ang napili",
                ...
                open: "Buksan",
                revoke: "Bawiin",
                noPublications: "Wala pang paglalathala.",
                confirmTitle: "Simulan ang paglalathala sa website ng mga resulta?",
                confirmDescription:
                    "Gagawa ito ng bagong paglalathala mula sa kasalukuyang pagpapatakbo ng tally. Ang mga umiiral na resulta na nakikita ng mga botante ay mananatiling aktibo hanggang matagumpay ang gawaing paglalathala na ito.",
                close: "Isara",
            },
            transmissionPackage: {
