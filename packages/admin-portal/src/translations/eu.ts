    ...
    translations: {
        ...
        tally: {
            ...
            pendingResolutions: {
                ...
                winner: "Irabazlea: {{candidate}}",
                filter: "Iragazi",
                save: "Gorde",
                lastSave: "Azken gordeta: {{date}}",
                ...
                tallyResumedBody: "Aurreratu den hautagaia: {{candidate}}. Bidaltzailea: {{user}}",
            },
            chart: {
