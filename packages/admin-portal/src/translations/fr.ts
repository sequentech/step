    ...
    "translations": {
        ...
        "votingScreen": {
            ...
            "ballotHelpDialog": {
                ...
                "content": "Cet écran montre le vote pour lequel vous êtes éligible. Vous pouvez sélectionner votre section en activant la case à droite Candidat/Réponse. Pour réinitialiser vos sélections, cliquez sur le bouton “<b>Effacer la sélection</b>”, pour passer à l'étape suivante, cliquez sur le bouton “<b>Suivant</b>”.",
                "ok": "OK"
            }
        },
        "startScreen": {
            ...
            "step1Description": "Sélectionnez vos options de vote qui sont présentées une par une. Vous configurerez ainsi les préférences de votre bulletin.",
            "step2Title": "2. Revoyez votre bulletin",
            "step2Description": "Une fois vos préférences choisies, nous les chiffrerons et vous obtiendrez un localisateur. Nous vous montrerons le contenu de votre bulletin pour que vous puissiez le réviser.",
            "step3Title": "3. Envoyez votre vote",
            "step3Description": "Vous pouvez envoyer votre vote à l'urne électronique pour qu'il soit dûment enregistré."
        },
        "reviewScreen": {
            "title": "Révisez votre bulletin",
            "description": "Pour modifier vos sélections, cliquez sur le bouton “<b>Changer la sélection</b>”, pour confirmer vos sélections, cliquez sur le bouton “<b>Soumettre le Bulletin</b>” ci-dessous, et pour auditer votre bulletin cliquez sur le bouton “<b>Auditer le Bulletin</b>” ci-dessous. Veuillez noter qu'une fois que vous soumettez votre bulletin, vous avez voté et il ne vous sera pas délivré un autre bulletin pour cette élection.",
        ...
        "confirmationScreen": {
            ...
            "description": "Le code de confirmation qui apparaît ci-dessous vérifie que <b>votre vote a été correctement émis</b>. Vous pouvez utiliser ce code pour vérifier que votre vote a été comptabilisé.",
            "ballotId": "Localisateur de Vote",
            "printButton": "Imprimer",
            "finishButton": "Terminer",
            "verifyCastTitle": "Vérifiez que votre vote a été émis",
            "verifyCastDescription": "Vous pouvez vérifier à tout moment que votre bulletin a été correctement émis en utilisant le code QR suivant:",
            "confirmationHelpDialog": {
                "title": "Information: Écran de confirmation",
                "content": "Cet écran montre que votre vote a été correctement émis. Les informations fournies sur cette page vous permettent de vérifier que le bulletin a été stocké dans l'urne, ce processus peut être exécuté à tout moment pendant la période de votation et après que l'élection a été clôturée.",
                "ok": "OK"
            },
            "ballotIdHelpDialog": {
                "title": "Information: Localisateur de Vote",
                "content": "Le Localisateur de Vote de bulletin est un code qui vous permet de trouver votre bulletin dans l'urne, ce Localisateur est unique et ne contient pas d'informations sur vos sélections.",
                "ok": "OK"
            }
        },
        "auditScreen": {
            ...
            "step1Description": "Votre <b>Localisateur de Vote</b> qui apparaît en haut de l'écran et votre bulletin chiffré ci-dessous:",
            "step1HelpDialog": {
                "title": "Copier le Vote Chiffré",
                "content": "Vous pouvez télécharger ou copier votre Vote Chiffré pour l'auditer et vérifier que le contenu chiffré contient vos sélections.",
                "ok": "OK"
            },
            "downloadButton": "Télécharger",
            "step2Title": "2. Suivez les étapes de ce tutoriel",
            "step2Description": '(<a href="https://github.com/sequentech/new-ballot-verifier/blob/main/README.md">cliquez ici</a>, cela ouvrira un nouvel onglet dans votre navigateur)',
            "step2HelpDialog": {
                "title": "Tutoriel sur l'Audit du Vote",
                "content": "Pour auditer votre vote, vous devrez suivre les étapes indiquées dans le tutoriel, qui incluent le téléchargement d'une application de bureau utilisée pour vérifier le vote chiffré indépendamment du site web.",
                "ok": "OK"
            },
            "bottomWarning": "Pour des raisons de sécurité, lorsque vous auditez votre bulletin, vous devrez l'invalider. Pour continuer avec le processus de vote, cliquez sur ‘<b>Démarrer le vote/b>’."
        },
        ...
        "scheduleScreen": {
            ...
            "create": {
                ...
                "selectSchedule": "Sélectionnez un horaire de la liste prédéfinie ou écrivez-en un personnalisé"
            },
            "edit": {
                "title": "Éditer une date"
            },
            "eventTypes": {
                "SYSTEM_LOCKDOWN_FOR_INTERNET_VOTING_SETTINGS": "Verrouillage du système pour la finalisation de la configuration de vote par Internet",
        ...
        "electionEventScreen": {
            ...
            "keys": {
                ...
                "notify": {
                    "participateNow": "Vous avez été invité à participer à une Cérémonie de Clés. Veuillez <1>cliquer ci-dessous sur l'action de clé de la cérémonie</1> pour participer."
                }
            },
            "tabs": {
            ...
            "tally": {
                ...
                "notify": {
                    "participateNow": "Vous avez été invité à participer à une Cérémonie de Comptage. Veuillez <1>cliquer ci-dessous sur l'action de clé de la cérémonie</1> pour participer."
                }
            },
            "import": {
                ...
                "voters": "Électeurs",
                "votersParagraph": "Importez des électeurs en utilisant une feuille de calcul au format Valeurs Séparées par Tabulations (TSV). Téléchargez un exemple de fichier d'importation TSV ici.",
                "electionEventParagraph": "Importez des Événements Électoraux en utilisant un fichier JSON.",
                "elections": "Élections",
                "areas": "Zones",
                ...
                "importVotersSuccess": "Importation des Électeurs lancée en arrière-plan avec succès.",
                ...
                "shaDialog": {
                    ...
                    "description": "Vous n'avez pas entré le champ de Vérification de l'Intégrité (SHA-256). Confirmez que vous importez le fichier correct et que vous souhaitez l'importer."
                }
            }
        },
        "electionScreen": {
        ...
        "usersAndRolesScreen": {
            ...
            "users": {
                ...
                "fields": {
                    ...
                    "passwordUppercaseValidate": "Le mot de passe doit contenir au moins une lettre majuscule",
                    "passwordLowercaseValidate": "Le mot de passe doit contenir au moins une lettre minuscule",
                    "passwordDigitValidate": "Le mot de passe doit contenir au moins un chiffre",
                    "passwordSpecialCharValidate": "Le mot de passe doit contenir au moins un caractère spécial"
                },
                "delete": {
            ...
            "voters": {
                ...
                "notifications": {
                    ...
                    "manualVerificationError": "Erreur lors de la vérification manuelle de l'électeur",
                    "manualVerificationSuccess": "Électeur vérifié manuellement avec succès, télécharger PDF.."
                }
            },
            "roles": {
                "title": "Rôles",
        ...
        "keysGeneration": {
            "configureStep": {
                ...
                "subtitle": "Dans cette cérémonie, chaque autorité générera et téléchargera sa part des clés privées pour l'Événement Électoral. Pour continuer, choisissez les autorités qui participeront à la cérémonie et le seuil, qui est le nombre minimum d'autorités nécessaires pour compter.",
                "trusteeList": "Autorités",
                "threshold": "Seuil",
                "errorMinTrustees_one": "Vous avez sélectionné seulement {{selected}} autorité, mais vous devez en sélectionner au moins {{threshold}}.",
                "errorMinTrustees_other": "Vous avez sélectionné seulement {{selected}} autorités, mais vous devez en sélectionner au moins {{threshold}}.",
                "errorThreshold": "Vous avez sélectionné un seuil de {{selected}} mais il doit être entre {{min}} et {{max}}.",
                "errorCreatingCeremony": "Erreur lors de la création de la Cérémonie de Clés : {{error}}",
                ...
                "confirmdDialog": {
                    ...
                    "description": "Vous êtes sur le point de Créer une Cérémonie de Clés. Cette action notifiera aux Autorités de participer à la création et distribution des Clés de l'Événement Électoral."
                }
            },
            "ceremonyStep": {
                "cancel": "Annuler la Cérémonie de Clés",
                "progressHeader": "Progrès de la Cérémonie de Clés",
                "description": "Cet écran montre le progrès et les journaux de la Cérémonie de Clés de l'Événement Électoral. Dans la Cérémonie de Clés, chaque autorité générera et téléchargera son fragment de la clé privée pour l'Événement Électoral.",
                ...
                "confirmdDialog": {
                    ...
                    "description": "Vous êtes sur le point d'Annuler la Cérémonie de Clés. Après avoir effectué cette action, pour avoir une Cérémonie de Clés réussie, vous devrez en Créer une nouvelle."
                },
                "header": {
            ...
            "startStep": {
                ...
                "subtitle": "Vous êtes sur le point de participer à la Cérémonie de Clés en tant qu'Autorité (<strong>{{name}}</strong>). Cela implique les étapes suivantes :",
            ...
            "downloadStep": {
                ...
                "subtitle": "Pour continuer, veuillez télécharger et sauvegarder votre Clé Privée Cryptée sur au moins deux appareils différents :",
                ...
                "confirmdDialog": {
                    ...
                    "description": "Veuillez effectuer une copie de sauvegarde de votre Clé Privée Cryptée à au moins deux emplacements sécurisés différents et confirmez-le ensuite :",
            ...
            "checkStep": {
                ...
                "subtitle": "Chargez la Copie de Sauvegarde de votre Clé Privée Cryptée pour vérifier qu'elle est correcte. Vous pouvez essayer autant de fois que nécessaire, depuis vos différentes copies de sauvegarde :",
                "errorUploading": "Copa de Sauvegarde de la Clé Privée Cryptée invalide, veuillez réessayer",
        ...
        "tally": {
            ...
            "common": {
                ...
                "dialog": {
                    ...
                    "message": "Vous êtes sur le point de commencer une cérémonie de comptage. Cette action notifiera aux trustees d'importer leurs fragments de clé.",
                    "cancelMessage": "Vous êtes sur le point d'annuler la cérémonie de comptage. Cette action ne peut pas être annulée.",
                    "ceremony": "Tous les trustees requis ont vérifié leurs fragments de clé. Tout est prêt pour commencer à recevoir les résultats. Voulez-vous commencer le Comptage ?"
                }
            },
            "table": {
                "elections": "Élections",
