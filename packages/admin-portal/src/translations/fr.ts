    ...
    translations: {
        ...
        electionEventScreen: {
            common: {
                ...
                allowPublishAfterLockdown: "Autoriser la publication de l'événement électoral uniquement après le confinement",
            ...
            edit: {
                ...
                realm_attributes: "Attributs du realm Keycloak",
                realm_attributes_load_error: "Erreur lors du chargement des attributs du realm Keycloak",
                realm_attributes_update_error: "Erreur lors de la mise à jour des attributs du realm Keycloak",
                realm_attributes_not_loaded:
                    "Les attributs du realm Keycloak n'ont pas été chargés, les modifications n'ont pas été enregistrées",
                password_policy: "Politique de mot de passe",
                password_policy_load_error: "Erreur lors du chargement de la politique de mot de passe Keycloak",
                password_policy_update_error: "Erreur lors de la mise à jour de la politique de mot de passe Keycloak",
                password_policy_not_loaded:
                    "La politique de mot de passe Keycloak n'a pas été chargée, les modifications n'ont pas été enregistrées",
            },
            customUrls: {
                login: "Connexion",
            ...
            field: {
                ...
                VoterCertificatePolicy: {
                    policyLabel: "Politique de Certificat Numérique de l'Électeur",
                    enabled: "Activé",
                    disabled: "Désactivé",
                },
                enrollment: {
            ...
            importAreas: {
                ...
                upsert: "Insérer ou Mettre à Jour des Zones",
            },
            import: {
                ...
                importElectionEventSuccess: "Événement électoral importé avec succès",
                importElectionEventError: "Erreur lors de l'importation de l'événement électoral",
                shaDialog: {
        ...
        usersAndRolesScreen: {
            ...
            users: {
                ...
                delete: {
                    ...
                    bulkBodySelected: "Supprimer les {{count}} utilisateurs sélectionnés ? Cette action est irréversible.",
                    bulkBodyChoose:
                    ...
                    okAllMatching: "Supprimer toutes les correspondances",
                },
                notifications: {
            ...
            permissions: {
                ...
                "contest-create": "Créer Concours",
                "contest-delete": "Supprimer Concours",
                "candidate-create": "Créer Candidat",
                "candidate-delete": "Supprimer Candidat",
                "election-create": "Créer Élection",
                "election-read": "Lire Élection",
                "election-write": "Éditer Élection",
                "election-delete": "Supprimer Élection",
                "election-event-archive": "Archiver l'Événement Électoral",
        ...
        eventsScreen: {
            ...
            eventType: {
                label: "Type",
                ALLOW_INIT_REPORT: "Autoriser le Rapport d'Initialisation",
                START_VOTING_PERIOD: "Début de la Période de Vote",
                END_VOTING_PERIOD: "Fin de la Période de Vote",
                ALLOW_VOTING_PERIOD_END: "Autoriser la Fin de la Période de Vote",
        ...
        importResource: {
            ...
            ImportHashMismatch: "Les hachages ne correspondent pas. Échec de la vérification d'intégrité.",
        },
        sideMenu: {
        ...
        tally: {
            ...
            resultsPublication: {
                sectionTitle: "Publier sur le site des résultats",
                policyTitle: "Site des résultats",
                policyAccess: "Accès au site des résultats",
                policyVisibility: "Visibilité du site des résultats",
                enabled: "Activé",
                disabled: "Désactivé",
                fullEvent: "Événement complet",
                areaBased: "Par zone",
                publishStarted: "La publication des résultats a commencé",
                publishError: "Impossible de démarrer la publication des résultats",
                revoked: "Publication des résultats révoquée",
                revokeError: "Impossible de révoquer la publication des résultats",
                waitingForTally: "Les résultats pourront être publiés une fois ce comptage terminé.",
                writePermissionRequired:
                    "Vous avez besoin de la permission publish-results-write pour publier ou révoquer des résultats.",
                readPermissionRequired:
                    "Vous avez besoin de la permission publish-results-read pour consulter l'historique des publications.",
                disabledPolicy:
                    "La publication sur le site des résultats est désactivée pour cet événement électoral. Activez-la dans les données de l'événement électoral avant de publier les résultats.",
                loadingElectionContext: "La publication des résultats charge le contexte de l'élection.",
                route: "Route",
                eventResults: "Résultats de l'événement",
                ...
                fullPublishedScope: "Portée publiée complète",
                personalVisibility: "Visibilité personnelle",
                contests: "Concours",
                noTalliedContests: "Aucun concours dépouillé disponible.",
                publishSelectedContests: "Publier les concours sélectionnés",
                selectedContestCount: "{{count}} concours sélectionné",
                selectedContestCount_plural: "{{count}} concours sélectionnés",
                ...
                confirmTitle: "Démarrer la publication sur le site des résultats ?",
                confirmDescription:
                    "Cela créera une nouvelle publication à partir de l'exécution actuelle du comptage. Les résultats actuellement visibles par les électeurs restent actifs jusqu'à ce que cette tâche de publication réussisse.",
                close: "Fermer",
            },
            transmissionPackage: {
