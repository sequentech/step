...
const spanishTranslation: TranslationType = {
    translations: {
        ...
        tallySheetImport: {
            title: "Importaciones de actas de escrutinio",
            subtitle:
                "Importa archivos de actas de escrutinio ES&S o CSV, previsualiza las urnas generadas y apruébalas antes de crear actas de escrutinio.",
            createTitle: "Importar actas de escrutinio",
            detailTitle: "Importación de acta de escrutinio",
            empty: "Todavía no hay importaciones de actas de escrutinio.",
            emptyBody:
                "Empieza importando un archivo ES&S Enhanced XML o CSV canónico para este evento electoral.",
            sourceFormat: {
            ...
            fields: {
                ...
                generatedTallySheet: "Acta de escrutinio generada",
                sourceCandidates: "IDs de candidatos de origen",
                none: "Ninguno",
            },
            actions: {
            ...
            notifications: {
                selectFile: "Selecciona un archivo de importación antes de previsualizarlo",
                duplicateSource:
                    "Este hash de archivo de origen ya aparece en una importación de acta de escrutinio anterior.",
                uploadUrlError: "No se pudo crear la URL de subida",
                uploadError: "No se pudo subir el archivo de importación",
                previewEmpty: "La respuesta de la previsualización estaba vacía",
                previewError: "No se pudo previsualizar la importación",
                importEmpty: "La respuesta de la importación estaba vacía",
                created: "Se ha creado la importación del acta de escrutinio",
                createError: "No se pudo crear la importación",
                reviewEmpty: "La respuesta de la revisión estaba vacía",
                conflicted: "La importación tiene conflictos de línea base desactualizados",
                approved: "Se ha aprobado la importación",
                disapproved: "Se ha desaprobado la importación",
                reviewError: "No se pudo revisar la importación",
                sourceUrlError: "No se pudo crear la URL de descarga de origen",
                sourceDownloadError: "No se pudo descargar el archivo de origen",
            },
            pagination: {
        ...
        dashboard: {
            ...
            votesOverTime: "Votos a lo largo del tiempo",
        ...
        electionEventScreen: {
            common: {
                ...
                allowPublishAfterLockdown: "Permitir la publicación del evento electoral solo después del confinamiento",
            ...
            edit: {
                ...
                realm_attributes_update_error: "Error al actualizar los atributos del realm de Keycloak",
                realm_attributes_not_loaded:
                    "No se han cargado los atributos del realm de Keycloak, los cambios no se guardaron",
                password_policy: "Política de contraseñas",
                password_policy_load_error: "Error al cargar la política de contraseñas de Keycloak",
                password_policy_update_error: "Error al actualizar la política de contraseñas de Keycloak",
                password_policy_not_loaded:
                    "No se ha cargado la política de contraseñas de Keycloak, los cambios no se guardaron",
            },
            customUrls: {
            ...
            field: {
                ...
                automaticRecountPolicy: {
                    policyLabel: "Recuento automático tras aprobar una importación",
                    options: {
                        enabled: "Habilitado",
                        disabled: "Deshabilitado",
                    },
            ...
            error: {
                ...
                noResult: "Todavía no hay Evento Electoral",
            ...
            export: {
                ...
                copiedSuccess: "Contraseña copiada al portapapeles",
        ...
        usersAndRolesScreen: {
            ...
            users: {
                ...
                delete: {
                    ...
                    bulkBodySelected: "¿Eliminar los {{count}} usuarios seleccionados? Esta acción no se puede deshacer.",
                    bulkBodyChoose:
                        "Hay {{count}} usuarios seleccionados. En su lugar, puedes eliminar todos los usuarios que coincidan con los filtros actuales, que pueden ser más. Esta acción no se puede deshacer.",
                    okSelected: "Eliminar los {{count}} seleccionados",
                    okAllMatching: "Eliminar todos los coincidentes",
                },
                notifications: {
            ...
            voters: {
                ...
                delete: {
                    ...
                    bulkBodySelected:
                        "¿Eliminar los {{count}} votantes seleccionados? Esta acción no se puede deshacer.",
                    bulkBodyChoose:
                        "Hay {{count}} votantes seleccionados. En su lugar, puedes eliminar todos los votantes que coincidan con los filtros actuales, que pueden ser más. Esta acción no se puede deshacer.",
                    okSelected: "Eliminar los {{count}} seleccionados",
                    okAllMatching: "Eliminar todos los coincidentes",
                },
                notifications: {
            ...
            permissions: {
                ...
                "tally-sheet-import-view": "Ver importación de actas de recuento",
                "tally-recount-execute": "Ejecutar recuento de resultados",
        ...
        eventsScreen: {
            ...
            eventType: {
                ...
                ALLOW_VOTING_PERIOD_END: "Permitir Fin del Período de Votación",
        ...
        importResource: {
            ...
            ImportHashMismatch: "Los hashes no coinciden. Error de comprobación de integridad.",
        },
        sideMenu: {
        ...
        tally: {
            ...
            resultsPublication: {
                ...
                areaBased: "Basado en áreas",
                publishStarted: "Se ha iniciado la publicación de resultados",
                publishError: "No se pudo iniciar la publicación de resultados",
                revoked: "Se ha revocado la publicación de resultados",
                revokeError: "No se pudo revocar la publicación de resultados",
                waitingForTally: "Los resultados podrán publicarse una vez que este recuento haya finalizado.",
                writePermissionRequired:
                    "Necesita el permiso publish-results-write para publicar o revocar resultados.",
                readPermissionRequired:
                    "Necesita el permiso publish-results-read para ver el historial de publicaciones.",
                disabledPolicy:
                    "La publicación en el sitio web de resultados está deshabilitada para este evento electoral. Actívela en los datos del evento electoral antes de publicar resultados.",
                loadingElectionContext: "La publicación de resultados está cargando el contexto de la elección.",
                route: "Ruta",
                ...
                contests: "Concursos",
                noTalliedContests: "No hay concursos escrutados disponibles.",
                ...
                confirmDescription:
                    "Esto creará una nueva publicación a partir de la ejecución actual del recuento. Los resultados visibles para los votantes permanecerán activos hasta que esta tarea de publicación se complete con éxito.",
                close: "Cerrar",
            },
            transmissionPackage: {
            ...
            trusteeTallyTitle: "Fideicomisarios",
        ...
        publish: {
            ...
            action: {
                ...
                startTelephoneVoting: "Comenzar Votación Telefónica",
        ...
        tallysheet: {
            ...
            versionsTable: {
                ...
                sourceImport: "Importación de origen",
