...
export type Mutation_Root = {
  ...
  set_custom_urls: Scalars['String']['output'];
...
export type SetCustomUrlsMutation = { __typename?: 'mutation_root', set_custom_urls: string };
