...
export type Mutation_Root = {
  ...
  /** set_custom_url */
  set_custom_url: Scalars['String']['output'];
...
export type SetCustomUrlMutationVariables = Exact<{
  origin: Scalars['String']['input'];
  redirect_to: Scalars['String']['input'];
}>;


export type SetCustomUrlMutation = { __typename?: 'mutation_root', set_custom_url: string };
...
export const SetCustomUrlDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetCustomUrl"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"origin"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"redirect_to"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"set_custom_url"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"origin"},"value":{"kind":"Variable","name":{"kind":"Name","value":"origin"}}},{"kind":"Argument","name":{"kind":"Name","value":"redirect_to"},"value":{"kind":"Variable","name":{"kind":"Name","value":"redirect_to"}}}]}]}}]} as unknown as DocumentNode<SetCustomUrlMutation, SetCustomUrlMutationVariables>;
