...
export type GetEventListQuery = { __typename?: 'query_root', get_event_list?: { __typename?: 'DataEventList', items: Array<{ __typename?: 'EventListRow', election: string, schedule?: any | null, id: string, tenant_id: string, election_event_id: string, event_type: string, receivers?: Array<string | null> | null, template?: any | null, name: string } | null>, total: { __typename?: 'TotalAggregate', aggregate: { __typename?: 'Aggregate', count: number } } } | null };
