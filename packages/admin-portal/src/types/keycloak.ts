...
import type {IPermissions as WasmIPermissions} from "sequent-core"
...
export const IPermissions = {
    ...
    KEYCLOAK_REALM_ATTRIBUTES_READ:
        "keycloak-realm-attributes-read" as WasmIPermissions.KEYCLOAK_REALM_ATTRIBUTES_READ,
    KEYCLOAK_REALM_ATTRIBUTES_WRITE:
        "keycloak-realm-attributes-write" as WasmIPermissions.KEYCLOAK_REALM_ATTRIBUTES_WRITE,
...
export type IPermissions = WasmIPermissions | (typeof IPermissions)[keyof typeof IPermissions]
