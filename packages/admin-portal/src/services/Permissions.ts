...
const AdminOperationMap: Record<string, IPermissions> = {
    ...
    insert_sequent_backend_candidate: IPermissions.CANDIDATE_WRITE,
    insert_sequent_backend_candidates: IPermissions.CANDIDATE_WRITE,
    ...
    delete_sequent_backend_candidate: IPermissions.CANDIDATE_WRITE,
    delete_sequent_backend_candidates: IPermissions.CANDIDATE_WRITE,
    // cast_vote
    ...
    insert_sequent_backend_contest: IPermissions.CONTEST_WRITE,
    insert_sequent_backend_contests: IPermissions.CONTEST_WRITE,
    update_sequent_backend_contest: IPermissions.CONTEST_WRITE,
    update_sequent_backend_contests: IPermissions.CONTEST_WRITE,
    delete_sequent_backend_contest: IPermissions.CONTEST_WRITE,
    delete_sequent_backend_contests: IPermissions.CONTEST_WRITE,
    // document
