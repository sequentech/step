    ...
    rocket::build()
        ...
        .mount(
            ...
            routes![
                ...
                routes::trustee_artifacts::get_artifact_upload_url,
                routes::trustee_artifacts::get_artifact_download_url,
                ...
                routes::key_commitment::record_key_commitment_route,
                routes::key_commitment::verify_key_commitment_route,
