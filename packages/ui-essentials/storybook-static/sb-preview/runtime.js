...
var require_getRawTag = __commonJS({
    "../../node_modules/lodash/_getRawTag.js"(exports, module) {
        ...
        function getRawTag2(value2) {
            ...
            return (
                unmasked &&
                    (isOwn ? (value2[symToStringTag3] = tag) : delete value2[symToStringTag3]),
                result2
            )
        }
...
var require_baseIsTypedArray = __commonJS({
    "../../node_modules/lodash/_baseIsTypedArray.js"(exports, module) {
        ...
        typedArrayTags[argsTag] = typedArrayTags[arrayTag] = typedArrayTags[
            ...
            regexpTag
        ] = typedArrayTags[setTag] = typedArrayTags[stringTag] = typedArrayTags[weakMapTag] = !1
    ...
    "../../node_modules/lodash/_listCacheSet.js"(exports, module) {
        ...
        function listCacheSet2(key2, value2) {
            var data = this.__data__,
                index = assocIndexOf2(data, key2)
            return (
                index < 0 ? (++this.size, data.push([key2, value2])) : (data[index][1] = value2),
                this
            )
        }
        ...
        function equalByTag(object, other, tag, bitmask, customizer, equalFunc, stack) {
            switch (tag) {
                ...
                case setTag:
                    var isPartial = bitmask & COMPARE_PARTIAL_FLAG
                    if (
                        (convert || (convert = setToArray), object.size != other.size && !isPartial)
                    )
                        return !1
...
var getEventSourceUrl = (event) => {
        ...
        return (
            remainder.length > 0 && logger.error("found multiple candidates for event source"), null
        )
    },
...
function useArgs() {
    let channel = addons.getChannel(),
        ...
        resetArgs = useCallback((argNames) => channel.emit(RESET_STORY_ARGS, {storyId, argNames}), [
            channel,
            storyId,
        ])
...
var CSF_CACHE_SIZE = 1e3,
    ...
    StoryStore = class {
        ...
        loadAllCSFFiles({batchSize = EXTRACT_BATCH_SIZE} = {}) {
            ...
            let importPaths = Object.entries(
                    this.storyIndex.entries
                ).map(([storyId, {importPath}]) => [importPath, storyId]),
...
var userOrAutoTitleFromSpecifier = (fileName, entry, userTitle) => {
    ...
    sortStoriesCommon = (stories, storySortParameter, fileNameOrder) => {
        if (storySortParameter) {
            ...
            stories.sort(
                (s1, s2) =>
                    fileNameOrder.indexOf(s1.importPath) - fileNameOrder.indexOf(s2.importPath)
            )
        return stories
    },
...
var StoryRender = class {
        ...
        async renderToElement(canvasElement) {
            return (
                (this.canvasElement = canvasElement), this.render({initial: !0, forceRemount: !0})
            )
        }
        storyContext() {
    ...
    CsfDocsRender = class {
        ...
        docsContext(renderStoryToElement) {
            ...
            return (
                this.csfFiles.forEach((csfFile) => docsContext.attachCSFFile(csfFile)), docsContext
            )
        }
...
`))),
                (document22.getElementById("error-message").innerHTML = ansiConverter.toHtml(
                    header
                )),
