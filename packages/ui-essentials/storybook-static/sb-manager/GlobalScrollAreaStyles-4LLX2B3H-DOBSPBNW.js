...
var getScrollAreaStyles = (theme) => ({
        ...
        ".os-size-observer-listener-scroll": {boxSizing: "border-box", display: "flex"},
        ".os-size-observer-listener-item": {
            right: "0",
            bottom: "0",
            overflow: "hidden",
        ...
        "[data-overlayscrollbars-overflow-x=hidden]": {overflowX: "hidden", overflowY: "hidden"},
        ...
        ".os-scrollbar-rtl.os-scrollbar-vertical .os-scrollbar-handle": {right: "auto", left: "0"},
        ...
        ".os-no-css-vars.os-theme-dark .os-scrollbar-handle": {background: "rgba(0, 0, 0, 0.44)"},
