import {
    ...
    renderStorybookUI,
    rgba,
} from "./chunk-VA3FBNGM.js"
import "./chunk-V7GYLJLR.js"
import {require_react_dom} from "./chunk-SJD7EFYL.js"
import "./chunk-JMPBYCHU.js"
import {dist_exports, dist_exports2 as dist_exports6, newStyled, scope} from "./chunk-6KNXZZZ5.js"
...
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
    ...
    function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
        ...
        return (Provider2.displayName = rootComponentName + "Provider"), [Provider2, useContext]
    }
    let createScope = () => {
...
function $e02a7d9cb1dc128c$export$c74125a8e3af6bb2(name) {
    let PROVIDER_NAME = name + "CollectionProvider",
        [createCollectionContext, createCollectionScope] = $c512c27ab02ef895$export$50c7b4e9d9f19c1(
            PROVIDER_NAME
        ),
        [CollectionProviderImpl, useCollectionContext] = createCollectionContext(PROVIDER_NAME, {
        ...
        CollectionItemSlot = import_react4.default.forwardRef((props, forwardedRef) => {
            let {scope: scope2, children, ...itemData} = props,
                ref = import_react4.default.useRef(null),
                composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, ref),
    ...
    function useCollection(scope2) {
        ...
        return import_react4.default.useCallback(() => {
            ...
            return Array.from(context.itemMap.values()).sort(
                (a3, b3) =>
                    orderedNodes.indexOf(a3.ref.current) - orderedNodes.indexOf(b3.ref.current)
            )
...
var import_react5 = __toESM(require_react(), 1),
    $f631663db3294ace$var$DirectionContext = (0, import_react5.createContext)(void 0)
function $f631663db3294ace$export$b39126d51d94e6f3(localDir) {
    let globalDir = (0, import_react5.useContext)($f631663db3294ace$var$DirectionContext)
...
var $d3863c46a17e8a28$export$20e40289641fbbb6 = (0, import_react11.forwardRef)(
    (props, forwardedRef) => {
        ...
        return (0, import_react11.createElement)(
            $8927f6f2acc4f386$export$250ffa63cdc0d034.div,
            _extends({tabIndex: -1}, scopeProps, {ref: composedRefs, onKeyDown: handleKeyDown})
        )
    }
)
...
function $d3863c46a17e8a28$var$findVisible(elements, container) {
    for (let element of elements)
        if (!$d3863c46a17e8a28$var$isHidden(element, {upTo: container})) return element
}
...
var r = async (t2, e2, n3) => {
    ...
    for (let n4 = 0; n4 < s3.length; n4++) {
        let {name: a4, fn: h3} = s3[n4],
            {x: y3, y: x3, data: w3, reset: v3} = await h3({
                x: m3,
                y: u3,
                initialPlacement: o3,
                placement: g3,
    ...
    let {x: o3, y: i3, platform: r3, rects: c3, elements: f3, strategy: m3} = t2,
        ...
        w3 = s(
            await r3.getClippingRect({
                element:
                    (n3 = await (r3.isElement == null ? void 0 : r3.isElement(x3))) == null || n3
                        ? x3
                        : x3.contextElement ||
        ...
        b3 = await (r3.getOffsetParent == null ? void 0 : r3.getOffsetParent(f3.floating)),
...
var g = (n3) => ({
        ...
        options: n3,
        async fn(i3) {
            let {x: r3, y: s3, placement: c3, rects: m3, platform: g3, elements: d3} = i3,
            ...
            let y3 = l(h3),
                ...
                L3 = await (g3.getOffsetParent == null ? void 0 : g3.getOffsetParent(p3)),
                k2 = L3 ? L3[E3] : 0
            ...
            async fn(e2) {
                ...
                switch (o3) {
                    case "referenceHidden": {
                        let t3 = R(await c(e2, {...i3, elementContext: "reference"}), n3.reference)
                ...
                let {x: r3, y: l3} = i3,
                    s3 = await (async function (e3, i4) {
                        let {placement: r4, platform: l4, elements: s4} = e3,
                            ...
                            d3 = c3 && u3 ? -1 : 1,
                            p3 = a(i4, e3),
                            {mainAxis: h3, crossAxis: y3, alignmentAxis: x3} =
                                typeof p3 == "number"
            ...
            e2 === void 0 && (e2 = {}),
            {
                ...
                async fn(i3) {
                    ...
                    if (E3 && !y3) {
                        ...
                        x3
                            ? (D3 =
                                  w3 - 2 * (t2 !== 0 || e3 !== 0 ? t2 + e3 : m(p3.left, p3.right)))
                            : (T2 =
                                  v3 - 2 * (n3 !== 0 || o3 !== 0 ? n3 + o3 : m(p3.top, p3.bottom)))
                    }
...
function l2(t2) {
    return typeof ShadowRoot < "u" && (t2 instanceof n2(t2).ShadowRoot || t2 instanceof ShadowRoot)
}
function s2(t2) {
    let {overflow: e2, overflowX: n3, overflowY: i3, display: r3} = o2(t2)
    return (
        /auto|scroll|overlay|hidden|clip/.test(e2 + i3 + n3) && !["inline", "contents"].includes(r3)
    )
}
function f2(t2) {
...
function u2(t2) {
    ...
    return (
        ...
        ["transform", "perspective", "filter"].some((t3) => (n3.willChange || "").includes(t3)) ||
        ["paint", "layout", "strict", "content"].some((t3) => (n3.contain || "").includes(t3))
    )
}
function a2() {
...
function S(t2) {
    var e2
    return (e2 = (i2(t2) ? t2.ownerDocument : t2.document) || window.document) == null
        ? void 0
        : e2.documentElement
}
function C2(t2) {
    ...
    if (i3 === "viewport")
        ...
        l3 = (function (t2) {
            let e3 = S(t2),
                ...
                c3 = p2(e3.scrollHeight, e3.clientHeight, i4.scrollHeight, i4.clientHeight),
                l4 = -n3.scrollLeft + C2(t2),
                s3 = -n3.scrollTop
            return (
                o2(i4).direction === "rtl" && (l4 += p2(e3.clientWidth, i4.clientWidth) - r4),
...
function W(t2, e2) {
    let n3 = F(t2)
    return !(n3 === e2 || !x2(n3) || d2(n3)) && (o2(n3).position === "fixed" || W(n3, e2))
}
function M(t2, e2, n3) {
    let o3 = c2(e2),
        i3 = S(e2),
...
function z(t2, e2) {
    return c2(t2) && o2(t2).position !== "fixed" ? (e2 ? e2(t2) : t2.offsetParent) : null
}
function P2(t2, e2) {
    let i3 = n2(t2)
    if (!c2(t2)) return i3
    ...
    return l3 &&
        (r2(l3) === "html" || (r2(l3) === "body" && o2(l3).position === "static" && !u2(l3)))
        ? i3
        : l3 ||
              (function (t3) {
                  let e3 = F(t3)
...
var React = __toESM(require_react()),
    ...
    arrow = (options) => {
        ...
        return {
            ...
            options,
            fn(state) {
                let {element, padding} = typeof options == "function" ? options(state) : options
    ...
    index = typeof document < "u" ? import_react13.useLayoutEffect : import_react13.useEffect
function deepEqual(a3, b3) {
    ...
    if (a3 && b3 && typeof a3 == "object") {
        ...
        if (((keys = Object.keys(a3)), (length = keys.length), length !== Object.keys(b3).length))
            return !1
        for (i3 = length; i3-- !== 0; ) if (!{}.hasOwnProperty.call(b3, keys[i3])) return !1
        for (i3 = length; i3-- !== 0; ) {
            let key = keys[i3]
            if (!(key === "_owner" && a3.$$typeof) && !deepEqual(a3[key], b3[key])) return !1
        }
        return !0
    }
    return a3 !== a3 && b3 !== b3
...
function useFloating(options) {
    ...
    let refs = React.useMemo(
        ...
        elements = React.useMemo(() => ({reference: referenceEl, floating: floatingEl}), [
            referenceEl,
            floatingEl,
        ]),
    ...
    return React.useMemo(() => ({...data, update, refs, elements, floatingStyles}), [
        data,
        update,
        refs,
        elements,
    ...
    $cf1ac5d9fe0e8206$export$bc4ae5855d3c4fc = (0, import_react15.forwardRef)(
        (props, forwardedRef) => {
            ...
            let {
                ...
                arrowWidth =
                    (_arrowSize$width = arrowSize?.width) !== null && _arrowSize$width !== void 0
                        ? _arrowSize$width
                        : 0,
                arrowHeight =
                    (_arrowSize$height = arrowSize?.height) !== null && _arrowSize$height !== void 0
                        ? _arrowSize$height
                        : 0,
                ...
                {refs, floatingStyles, placement, isPositioned, middlewareData} = useFloating({
                    ...
                    middleware: [
                        L({mainAxis: sideOffset + arrowHeight, alignmentAxis: alignOffset}),
                        avoidCollisions &&
                            O({
                                mainAxis: !0,
                                crossAxis: !1,
                        ...
                        C({
                            ...
                            apply: ({elements, rects, availableWidth, availableHeight}) => {
                                let {width: anchorWidth, height: anchorHeight} = rects.reference,
                ...
                [placedSide, placedAlign] = $cf1ac5d9fe0e8206$var$getSideAndAlignFromPlacement(
                    placement
                ),
            ...
            function () {
                hiddenNodes.forEach(function (node) {
                    ...
                    counterMap.set(node, counterValue),
                        markerCounter.set(node, markerValue),
                        counterValue ||
                            (uncontrolledNodes.has(node) || node.removeAttribute(controlAttribute),
...
var $cc7e05a45900e73f$var$OPEN_KEYS = [" ", "Enter", "ArrowUp", "ArrowDown"],
    ...
    ] = $e02a7d9cb1dc128c$export$c74125a8e3af6bb2($cc7e05a45900e73f$var$SELECT_NAME),
    [
        $cc7e05a45900e73f$var$createSelectContext,
        $cc7e05a45900e73f$export$286727a75dc039bd,
    ] = $c512c27ab02ef895$export$50c7b4e9d9f19c1($cc7e05a45900e73f$var$SELECT_NAME, [
        $cc7e05a45900e73f$var$createCollectionScope,
        $cf1ac5d9fe0e8206$export$722aac194ae923,
    ]),
    ...
    ] = $cc7e05a45900e73f$var$createSelectContext($cc7e05a45900e73f$var$SELECT_NAME),
    [
    ...
    $cc7e05a45900e73f$export$ef9b1a59e592288f = (props) => {
        let {
            ...
            [valueNodeHasChildren, setValueNodeHasChildren] = (0, import_react21.useState)(!1),
            ...
            [nativeOptionsSet, setNativeOptionsSet] = (0, import_react21.useState)(new Set()),
    ...
    $cc7e05a45900e73f$export$e288731fd71264f0 = (0, import_react21.forwardRef)(
        (props, forwardedRef) => {
            let {__scopeSelect, className, style, children, placeholder, ...valueProps} = props,
                context = $cc7e05a45900e73f$var$useSelectContext(
            ...
            return (
                ...
                (0, import_react21.createElement)(
                    $8927f6f2acc4f386$export$250ffa63cdc0d034.span,
                    _extends({}, valueProps, {ref: composedRefs, style: {pointerEvents: "none"}}),
...
var $cc7e05a45900e73f$export$b2af6c9944296213 = (props) =>
    ...
    ] = $cc7e05a45900e73f$var$createSelectContext($cc7e05a45900e73f$var$CONTENT_NAME)
var $cc7e05a45900e73f$var$SelectContentImpl = (0, import_react21.forwardRef)(
    (props, forwardedRef) => {
        let {
            ...
            [selectedItemText, setSelectedItemText] = (0, import_react21.useState)(null),
            getItems = $cc7e05a45900e73f$var$useCollection(__scopeSelect),
        ...
        let [searchRef, handleTypeaheadSearch] = $cc7e05a45900e73f$var$useTypeaheadSearch(
                (search) => {
                    let enabledItems = getItems().filter((item) => !item.disabled),
            ...
            itemRefCallback = (0, import_react21.useCallback)(
                (node, value, disabled) => {
                    ...
                    ;((context.value !== void 0 && context.value === value) || isFirstValidItem) &&
                        (setSelectedItem(node),
                        isFirstValidItem && (firstValidItemFoundRef.current = !0))
                },
                [context.value]
            ),
            handleItemLeave = (0, import_react21.useCallback)(() => content?.focus(), [content]),
                                            ...
                                            if (
                                                ...
                                                if (
                                                    ...
                                                    let currentElement = event.target,
                                                        currentIndex = candidateNodes.indexOf(
                                                            currentElement
                                                        )
...
var $cc7e05a45900e73f$var$SelectItemAlignedPosition = (0, import_react21.forwardRef)(
    (props, forwardedRef) => {
                ...
                if (
                    ...
                    if (context.dir !== "rtl") {
                        let itemTextOffset = itemTextRect.left - contentRect.left,
                            ...
                            rightEdge = window.innerWidth - $cc7e05a45900e73f$var$CONTENT_MARGIN,
...
var $cc7e05a45900e73f$var$SelectPopperPosition = (0, import_react21.forwardRef)(
    ...
    ] = $cc7e05a45900e73f$var$createSelectContext($cc7e05a45900e73f$var$ITEM_NAME),
    $cc7e05a45900e73f$export$13ef48a934230896 = (0, import_react21.forwardRef)(
        (props, forwardedRef) => {
            let {
                ...
                [textValue, setTextValue] = (0, import_react21.useState)(textValueProp ?? ""),
                [isFocused, setIsFocused] = (0, import_react21.useState)(!1),
                composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, (node) => {
                    var _contentContext$itemR
                    return (_contentContext$itemR = contentContext.itemRefCallback) === null ||
                        _contentContext$itemR === void 0
                        ? void 0
                        : _contentContext$itemR.call(contentContext, node, value, disabled)
                }),
    ...
    $cc7e05a45900e73f$export$3572fb0fb821ff49 = (0, import_react21.forwardRef)(
        (props, forwardedRef) => {
            let {__scopeSelect, className, style, ...itemTextProps} = props,
                ...
                nativeOptionsContext = $cc7e05a45900e73f$var$useSelectNativeOptionsContext(
                    $cc7e05a45900e73f$var$ITEM_TEXT_NAME,
                    __scopeSelect
                ),
                ...
                composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
                    ...
                    (node) => {
                        ...
                        return (_contentContext$itemT = contentContext.itemTextRefCallback) ===
                            null || _contentContext$itemT === void 0
                            ? void 0
            ...
            return (
                ...
                (0, import_react21.createElement)(
                    ...
                    (0, import_react21.createElement)(
                        $8927f6f2acc4f386$export$250ffa63cdc0d034.span,
                        _extends({id: itemContext.textId}, itemTextProps, {ref: composedRefs})
                    ),
    ...
    $cc7e05a45900e73f$export$6b9198de19accfe6 = (0, import_react21.forwardRef)(
        (props, forwardedRef) => {
            ...
            return $cc7e05a45900e73f$var$useSelectItemContext(
                ...
                ? (0, import_react21.createElement)(
                      $8927f6f2acc4f386$export$250ffa63cdc0d034.span,
                      _extends({"aria-hidden": !0}, itemIndicatorProps, {ref: forwardedRef})
                  )
                : null
        }
    ),
    ...
    $cc7e05a45900e73f$var$SelectScrollButtonImpl = (0, import_react21.forwardRef)(
        (props, forwardedRef) => {
            ...
            return (
                (0, import_react21.useEffect)(() => () => clearAutoScrollTimer(), [
                    ...
                    _extends({"aria-hidden": !0}, scrollIndicatorProps, {
                        ...
                        onPointerMove: $e42e1063c40fb3ef$export$b9ecd428b558ff10(
                            ...
                            () => {
                                ...
                                ;(_contentContext$onIte3 = contentContext.onItemLeave) === null ||
...
function $cc7e05a45900e73f$var$useTypeaheadSearch(onSearchChange) {
    let handleSearchChange = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onSearchChange),
...
function $cc7e05a45900e73f$var$findNextItem(items, search, currentItem) {
    let normalizedSearch =
        ...
        wrappedItems = $cc7e05a45900e73f$var$wrapArray(items, Math.max(currentItemIndex, 0))
...
var $cc7e05a45900e73f$export$be92b6f5f03c0fe9 = $cc7e05a45900e73f$export$ef9b1a59e592288f,
    ...
    $cc7e05a45900e73f$export$eb2fcfdbd7ba97d4 = $cc7e05a45900e73f$export$ee25a334c55de1f4,
...
var import_react22 = __toESM(require_react(), 1),
    Fallback = ({size}) =>
        import_react22.default.createElement("div", {style: {width: size, height: size}})
...
var Photo = withSuspense(
    ...
    SidebarAltToggle = withSuspense(
        (0, import_react22.lazy)(async () => ({
            default: (await import("./Devices-OZM56PEU-YWWWQK4B.js")).SidebarAltToggle,
        }))
    ),
    ...
    CircleHollow = withSuspense(
        (0, import_react22.lazy)(async () => ({
            default: (await import("./Communicate-ILFU4JFX-SW5LX7M2.js")).CircleHollow,
        }))
    ),
    Circle = withSuspense(
        (0, import_react22.lazy)(async () => ({
    ...
    BookmarkHollow = withSuspense(
        (0, import_react22.lazy)(async () => ({
            default: (await import("./Communicate-ILFU4JFX-SW5LX7M2.js")).BookmarkHollow,
        }))
    ),
    ...
    ArrowSolidDown = withSuspense(
        (0, import_react22.lazy)(async () => ({
            default: (await import("./Wayfinding-AUSNPVSH-QFGOSTNT.js")).ArrowSolidDown,
        }))
    ),
    ArrowSolidLeft = withSuspense(
        (0, import_react22.lazy)(async () => ({
            default: (await import("./Wayfinding-AUSNPVSH-QFGOSTNT.js")).ArrowSolidLeft,
        }))
    ),
    ArrowSolidRight = withSuspense(
        (0, import_react22.lazy)(async () => ({
            default: (await import("./Wayfinding-AUSNPVSH-QFGOSTNT.js")).ArrowSolidRight,
        }))
    ),
...
var Button2 = (0, import_react23.forwardRef)(({as, children, icon, ...props}, ref) =>
        ...
        ({
            ...
            "color": `${(() =>
                variant === "primary"
                    ...
                    : theme.input.color)()}`,
            "boxShadow":
                variant === "secondary" ? `${theme.button.border} 0 0 0 1px inset` : "none",
        ...
        return React8.createElement(IconWrapper, {
            icon: React8.createElement(
                ...
                React8.createElement("path", {
                    d:
                        "M7.354.146l4 4a.5.5 0 01-.708.708L7 1.207 3.354 4.854a.5.5 0 11-.708-.708l4-4a.5.5 0 01.708 0zM11.354 9.146a.5.5 0 010 .708l-4 4a.5.5 0 01-.708 0l-4-4a.5.5 0 11.708-.708L7 12.793l3.646-3.647a.5.5 0 01.708 0z",
                    fill: "currentColor",
                })
            ),
            ...restProps,
    ...
    Arrowup = (allProps) => {
        ...
        return React8.createElement(IconWrapper, {
            icon: React8.createElement(
                ...
                React8.createElement("path", {
                    d:
                        "M7.354 2.896l5.5 5.5a.5.5 0 01-.708.708L7 3.957 1.854 9.104a.5.5 0 11-.708-.708l5.5-5.5a.5.5 0 01.708 0z",
                    fill: "currentColor",
                })
            ),
            ...restProps,
    ...
    Arrowdown = (allProps) => {
        ...
        return React8.createElement(IconWrapper, {
            icon: React8.createElement(
                ...
                React8.createElement("path", {
                    d:
                        "M1.146 5.604l5.5 5.5a.5.5 0 00.708 0l5.5-5.5a.5.5 0 00-.708-.708L7 10.043 1.854 4.896a.5.5 0 10-.708.708z",
                    fill: "currentColor",
                })
            ),
            ...restProps,
    ...
    Check2 = (allProps) => {
        ...
        return React8.createElement(IconWrapper, {
            icon: React8.createElement(
                ...
                React8.createElement("path", {
                    d:
                        "M13.854 3.354a.5.5 0 00-.708-.708L5 10.793.854 6.646a.5.5 0 10-.708.708l4.5 4.5a.5.5 0 00.708 0l8.5-8.5z",
                    fill: "currentColor",
                })
            ),
            ...restProps,
...
var SelectLabel = React8.forwardRef(({className, ...props}, ref) =>
    React8.createElement($cc7e05a45900e73f$export$b04be29aa201d4f5, {ref, ...props})
)
...
var SelectItem = React8.forwardRef(({className, children, ...props}, ref) =>
    React8.createElement(
        StyledItem,
        {ref, ...props},
        React8.createElement(StyledItemIndicator, null, React8.createElement(Check2, {size: 12})),
        React8.createElement($cc7e05a45900e73f$export$d6e5bf9c43ea9319, null, children)
    )
)
...
var SelectSeparator = React8.forwardRef(({className, ...props}, ref) =>
    React8.createElement($cc7e05a45900e73f$export$1ff3c3f08ae963c0, {ref, ...props})
)
...
var Select = {
    ...
    StyledTrigger = newStyled($cc7e05a45900e73f$export$41fb9f06171c75f4)(({theme}) => ({
        "all": "unset",
        "display": "flex",
        "width": "100%",
        "height": "32px",
    ...
    StyledContent = newStyled($cc7e05a45900e73f$export$7c6e2c02157bb7d2)(({theme}) => ({
        boxSizing: "border-box",
        overflow: "hidden",
    ...
    StyledScrollUpButton = newStyled($cc7e05a45900e73f$export$2f60d3ec9ad468f2)(({theme}) => ({
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        height: "25px",
    ...
    StyledScrollDownButton = newStyled($cc7e05a45900e73f$export$bf1aedc3039c8d63)(({theme}) => ({
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        height: "25px",
    ...
    StyledItem = newStyled($cc7e05a45900e73f$export$6d08773d2e66f8f2)(({theme}) => ({
        "fontSize": "13px",
        "lineHeight": 1,
        "color": theme.input.color,
        "borderRadius": "3px",
    ...
    Link2 = (0, import_react23.forwardRef)(({as, children, icon, withArrow, ...props}, ref) =>
        import_react23.default.createElement(
            StyledLink,
            {as, ref, ...props},
            import_react23.default.createElement(StyledLeft, null, icon, children),
            withArrow && import_react23.default.createElement(ChevronRight, {size: 8})
        )
    )
...
var Keys = ((Keys2) => (
    ...
    (Keys2["@storybook/components/experimental"] = "__STORYBOOKCOMPONENTSEXPERIMENTAL__"),
