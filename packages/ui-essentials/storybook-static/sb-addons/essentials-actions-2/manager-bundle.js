try {
    ...
    function D(e, t) {
        ...
        if (e && t && (r = e.constructor) === t.constructor) {
            ...
            if (r === Set) {
                ...
                for (n of e)
                    if (((o = n), (o && typeof o == "object" && ((o = Ue(t, o)), !o)) || !t.has(o)))
                        return !1
                return !0
            }
            if (r === Map) {
                ...
                for (n of e)
                    if (
                        ((o = n[0]),
                        (o && typeof o == "object" && ((o = Ue(t, o)), !o)) || !D(n[1], t.get(o)))
                    )
                        return !1
                return !0
            }
            ...
            if (!r || typeof e == "object") {
                n = 0
                for (r in e)
                    if ((je.call(e, r) && ++n && !je.call(t, r)) || !(r in t) || !D(e[r], t[r]))
                        return !1
        ...
        bt = (e, t, r, n) => {
            if ((t && typeof t == "object") || typeof t == "function")
                for (let o of Ye(t))
                    !dt.call(e, o) &&
                        o !== r &&
                        se(e, o, {get: () => t[o], enumerable: !(n = pt(t, o)) || n.enumerable})
            return e
        },
        gt = (e, t, r) => (
            (r = e != null ? ct(ft(e)) : {}),
            bt(t || !e || !e.__esModule ? se(r, "default", {value: e, enumerable: !0}) : r, e)
        ),
        ht = le({
    ...
    var Ot = {
        ...
        ue = (e) => ({theme: r = ae, ...n}) => {
            ...
            return a.createElement(qe.Provider, {value: o}, a.createElement(e, {...n}))
        },
    ...
    var ie = ({data: e}) => {
            ...
            if (Array.isArray(r)) {
                let n = t.arrayMaxProperties,
                    o = r.slice(0, n).map((u, s) => a.createElement(U, {key: s, object: u}))
        ...
        Lt = ({showNonenumerable: e = !1, sortObjectKeys: t, nodeRenderer: r, ...n}) => {
            let o = xt(e, t),
                i = r || Nt
    ...
    var Mt = ({rows: e, columns: t, rowsData: r}) => {
        ...
        zt = ({data: e, columns: t}) => {
            let r = _("TableInspector"),
                [{sorted: n, sortIndexColumn: o, sortColumn: i, sortAscending: u}, s] = I({
                    sorted: !1,
                    sortIndexColumn: !1,
                    sortColumn: void 0,
                    sortAscending: !1,
            ...
            switch (t.nodeType) {
                case Node.ELEMENT_NODE:
                    return a.createElement(
                        ...
                        !r && a.createElement($e, {tagName: t.tagName, styles: n.htmlCloseTag})
                    )
                case Node.TEXT_NODE:
    ...
    var Kt = /^#[a-fA-F0-9]{6}$/,
        ...
        rr = /^rgb(?:a)?\(\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i,
        nr = /^hsl\(\s*(\d{0,3}[.]?[0-9]+(?:deg)?)\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*\)$/i,
        ar = /^hsl(?:a)?\(\s*(\d{0,3}[.]?[0-9]+(?:deg)?)\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i
    function P(e) {
        ...
        if (i)
            return {
                ...
                alpha:
                    parseFloat("" + i[4]) > 1 ? parseFloat("" + i[4]) / 100 : parseFloat("" + i[4]),
            }
        var u = nr.exec(t)
        if (u) {
        ...
        if (f) {
            ...
            return {
                ...
                alpha:
                    parseFloat("" + f[4]) > 1 ? parseFloat("" + f[4]) / 100 : parseFloat("" + f[4]),
            }
        }
        throw new T(5)
    }
    ...
    function lr(e, t, r) {
        if (typeof e == "number" && typeof t == "number" && typeof r == "number") return Q(e, t, r)
    ...
    function wr(e, t) {
        ...
        var r = P(t),
            n = typeof r.alpha == "number" ? r.alpha : 1,
            o = v({}, r, {alpha: B(0, 1, +(n * 100 - parseFloat(e) * 100).toFixed(2) / 100)})
        return ee(o)
    }
    var fl = A(wr)
    var xr = j.div({
        ...
        Mr = ke(({theme: e, ...t}) =>
            a.createElement(et, {theme: e.addonActionsTheme || "chromeLight", table: !1, ...t})
        ),
                    ...
                    (this.addAction = (t) => {
                        this.setState((r) => {
                            let n = [...r.actions],
                                o = n.length && n[0]
                            return (
                                o && Br(o.data, t.data) ? o.count++ : ((t.count = 1), n.unshift(t)),
