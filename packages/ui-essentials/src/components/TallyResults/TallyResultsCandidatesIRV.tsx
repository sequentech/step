...
//
// Lifted from admin-portal/src/resources/Tally/TallyResultsCandidatesIRV.tsx.
// Adaptations:
//   I1: replace `useTranslation()` with the `t()` shim from ./strings (see L1).
//   I2: drop unused imports (useRef, ECandidateStatus, candidates_status
//       destructure) flagged by stricter lint settings; they were dead in
//       upstream too.
