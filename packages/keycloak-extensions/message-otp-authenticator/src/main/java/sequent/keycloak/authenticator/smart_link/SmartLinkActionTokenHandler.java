...
@JBossLog
public class SmartLinkActionTokenHandler 
  extends AbstractActionTokenHandler<SmartLinkActionToken>
{
    ...
    public AuthenticationSessionModel startFreshAuthenticationSession(
        ...
        ActionTokenContext<SmartLinkActionToken> tokenContext
    ) {
        return tokenContext
    ...
    public Response handleToken(
        ...
        log.infof(
            "handleToken(): called with iss=%s, user=%s",
            token.getIssuedFor(),
            token.getUserId()
        );
        UserModel user = tokenContext
        ...
        String shouldRedirect = RedirectUtils
            .verifyRedirectUri(session, redirectUri, client);
