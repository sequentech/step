...
// DobModels - Steps
import { InitialStep, InstructionsStep, DocCaptureStep, FaceCaptureStep, VideoIdentificationStep, AttachStep, EndStep } from './dob-models-1.1.20.esm.js';
// DobModels - Enums
import { EventType, InstructionsResourceType, DocSide, VideoType, Evidence, VoiceLanguage, ExceptionType, IOSBrowser, CountryCode, DesignType } from './dob-models-1.1.20.esm.js';
// DobModels - Utils
import { SDKUtils } from './dob-models-1.1.20.esm.js';
...
let myStringsLocaleMap = { 
  ...
  'tl': {
    ...
    'dob_api_back_doc_not_match': 'Ang mukha ng dokumento ay hindi tugma sa ipinadalang ebidensya',
    ...
    'dob_api_incorrect_mrz': 'Mukhang hindi sapat ang kalidad ng capture. Paki-ulit ang capture.',
    'dob_api_transaction_exists': 'Mayroon nang umiiral na proseso ng rehistrasyon.',
    'dob_api_younger': 'Ang kalakip na dokumento ay para sa isang menor de edad',
    'dob_api_incorrect_evidence': 'Ang ebidensya ay hindi tumutugma sa hinihiling na ebidensya.',
    ...
    // FACE-CAPTURE STEP
    'permissions_orientation_dialog_title': 'Upang mapahusay ang iyong karanasan, kailangan naming bigyan mo kami ng access sa orientation ng iyong telepono',
    'permissions_orientation_dialog_button': 'OK',
    ...
    'media_recorder_unknown_exception': 'Ang device o browser ay hindi sumusuporta sa video recording',
    'media_recorder_experimental_feature_exception': 'Ang video recording ay hindi naka-enable sa iyong device. Pumunta sa Settings > Safari > Advanced > Experimental Features at i-activate ang MediaRecorder flag',
    // ATTACH STEP
    'attach_button_text': 'Hanapin ang file',
    'attach_file_successfully_submitted': 'Matagumpay na na-upload ang iyong file!',
    'attach_on_uploading_file': 'Ina-upload ang file, sandali lang',
    'attach_multi_files_upload_error': 'Isang file lang ang pinapayagang i-upload',
    'attach_invalid_file_type_error': 'May error sa pagbabasa ng file na ito',
    'attach_processing_file': 'Pinoproseso ang file...',
    'attach_default_error': 'Ang attachment ay mukhang hindi akma sa mga kinakailangang pamantayan',
    ...
    'otp_verification_email': 'Ipinadala namin ang access code sa iyong email para sa verification.',
    'otp_verification_sms': 'Ipinadala namin ang access code sa iyong SMS para sa verification.',
    'otp_verification_resend_question': 'Hindi mo ba natanggap ang OTP code?',
    'otp_verification_resended_email': 'Isang bagong OTP code ang ipinadala sa iyong email address.',
    'otp_verification_resended_sms': 'Isang bagong OTP code ang ipinadala sa iyong mobile number.',
