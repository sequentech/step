...
public class RemoveUserAttributeTest {
    ...
    public void testAuthenticateExecutionNotRequired() {
        ...
        when(authConfig.getConfig()).thenReturn(Map.of(RemoveUserAttribute.CONF_USER_ATTRIBUTE, "test-attribute"));
    ...
    public void testAuthenticateUserAttributeRemoved() {
        ...
        when(context.getUser()).thenReturn(user);  
        when(context.getAuthenticatorConfig()).thenReturn(authConfig);
        when(authConfig.getConfig()).thenReturn(Map.of(RemoveUserAttribute.CONF_USER_ATTRIBUTE, testAttribute));
