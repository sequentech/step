...
import sequent.keycloak.security_question_authenticator.SecurityQuestionRequiredActionFactory;
...
public class SecurityQuestionAuthenticator implements Authenticator
{
    ...
    protected boolean validateAnswer(AuthenticationFlowContext context)
    {
     ...
     public List<RequiredActionFactory> getRequiredActions(
        ...
        return Collections
            .singletonList(
            (SecurityQuestionRequiredActionFactory) session
                .getKeycloakSessionFactory()
                .getProviderFactory(
                    RequiredActionProvider.class,
                    SecurityQuestionRequiredAction.PROVIDER_ID
                )
            );
    }
