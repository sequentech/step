...
// Characterization of the PREFERENCE-GAPS rule (preferential only):
// checker emissions + gate pair + recorded tally class.
//
...
const md = [
    ...
    "-->",
    "",
    "# Preference-gaps rule (preferential) — checker emissions + gate pair + recorded tally class",
    "",
