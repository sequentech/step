...
// marker candidate ("Spoil ballot") as a choice. The two routes produce
...
//
// Contest: Council seat (Ada / Bruno / Spoil-marker) from the
...
//   marker        — the Spoil marker candidate selected (flag derived at encode)
//   marker_plus   — Spoil marker + one regular candidate
...
const md = [
    ...
    "",
    "**Experiment:** the *Council seat* contest (Ada / Bruno / Spoil-marker,",
    ...
    "*marker* selects the Spoil marker candidate (the flag is then derived at",
