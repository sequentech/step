...
//! Per-ballot extended-metrics accumulators (over-votes, under-votes,
//! actual marks, expected marks). Used by counting algorithms to populate
//! `ExtendedMetricsContest` while iterating over ballots.
