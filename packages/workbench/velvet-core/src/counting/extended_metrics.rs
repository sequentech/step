...
//!
//! Classifies each ballot as valid, blank or invalid (each explicit or
//! implicit) or declined, and accumulates over-votes, under-votes, actual
//! marks and expected marks into `ExtendedMetricsContest`.
//!
