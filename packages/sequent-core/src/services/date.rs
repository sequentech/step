...
impl ISO8601 {
    /// Converts an RFC3339 string to a UTC `DateTime`.
    ///
    /// # Errors
    /// Returns an error if the string cannot be parsed as RFC3339.
    ...
    /// Converts a Local `DateTime` to an RFC3339 string.
    #[must_use]
    ...
    /// Converts a UTC timestamp in milliseconds to a Local `DateTime`.
    #[must_use]
    ...
    pub fn timestamp_ms_utc_to_date_opt(
        ...
        let LocalResult::Single(date_time_utc) =
    ...
    /// Converts a UTC timestamp in seconds to a Local `DateTime`.
    ///
    /// # Errors
    /// Returns an error if the timestamp cannot be parsed.
